...
TL;DR: The paper proposes MIDAS, a data augmentation method for dynamic facial expression recognition (DFER) that uses soft labels to handle ambiguous expressions, showing improved performance on existing datasets.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the accuracy of recognizing ambiguous facial expressions in real-world data for practical DFER applications.

Method: MIDAS is a data augmentation technique that convexly combines video frames and their soft labels (probability distributions over emotion classes) to create enhanced training data.

Result: Models trained with MIDAS outperformed the state-of-the-art method on the DFEW dataset and FERV39k-Plus, which uses soft labels.

Conclusion: MIDAS is a simple and effective method for handling ambiguity in DFER by leveraging soft labels in data augmentation.
...
TL;DR: This paper explores the geometric foundations of stereo vision systems, focusing on 3D structure and human-inspired perception for accurate depth reconstruction. It introduces new geometric constraints for occlusions and depth discontinuities, evaluates deep learning feature matching, and highlights the role of attention mechanisms. The study combines theoretical analysis with empirical results to show that integrating geometric priors with learned features enhances understanding of stereo vision.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the accuracy of depth reconstruction in stereo vision systems by leveraging geometric foundations and human-inspired perception, addressing challenges like occlusions and depth discontinuities.

Method: The method involves revisiting the Cyclopean Eye model, proposing new geometric constraints, evaluating stereo feature matching from deep learning models, and examining the role of attention mechanisms in 3D surface recovery.

Result: The results show that combining strong geometric priors with learned features provides internal abstractions that enhance the understanding of stereo vision systems, supported by theoretical insights and empirical studies on real datasets.

Conclusion: The conclusion emphasizes that integrating geometric priors with learned features, along with attention mechanisms, leads to more accurate depth reconstruction and better comprehension of stereo vision systems.
...
TL;DR: The paper introduces a new dataset for aviation weather using FAA images and benchmarks existing methods against an ASTM standard.


<details>
  <summary>Details</summary>
Motivation: To address the lack of publicly available datasets for atmospheric visibility estimation in aviation, which are necessary for supervised learning approaches.

Method: Data collection from FAA weather cameras over a year, creating a new dataset. Benchmarking three common approaches and a general-purpose baseline on multiple datasets including their own.

Result: The new dataset is created, and the benchmarking shows performance of methods compared to an ASTM standard.

Conclusion: The proposed dataset and benchmarking provide a foundation for developing low-cost alternatives to traditional weather sensors in aviation visibility estimation.
...
TL;DR: This paper proposes a step-by-step video-to-audio generation method that produces individual audio tracks for each sound event in a video, inspired by Foley workflows and concept negation, achieving higher-quality composite audio synthesis without specialized datasets.


<details>
  <summary>Details</summary>
Motivation: The motivation is to comprehensively capture all sound events induced by a video and improve the quality of composite audio synthesis by generating semantically distinct audio tracks for each event.

Method: The method involves a step-by-step approach where each audio track is generated based on a text prompt and previously generated tracks, using a training framework that relies on pre-trained video-to-audio models without requiring specialized paired data.

Result: The results show that the method can generate multiple semantically distinct audio tracks from a single video, resulting in higher-quality composite audio compared to existing baselines.

Conclusion: The conclusion is that the proposed method effectively enhances composite audio synthesis by sequentially generating audio tracks aligned with specific sound events, leveraging pre-trained models and accessible data without the need for specialized datasets.
...
TL;DR: This paper introduces Inverse STR (ISTR) to detect and localize text removal in images, showing high accuracy in classification and localization tasks, and attempts to recover removed text content.


<details>
  <summary>Details</summary>
Motivation: To address the increasing misuse risks of Scene Text Removal (STR) and improve its detection and recovery capabilities.

Method: Investigating ISTR through binary classification and localization of removed text regions, and training a text recognizer to recover content.

Result: High accuracy in detecting and localizing text removal, enabling misuse detection and enhancing STR.

Conclusion: ISTR is feasible and effective, offering potential for detecting misuse and improving STR methods.
...
TL;DR: The paper introduces a method for novel view synthesis using locally reconstructed light fields and error visualization, eliminating the need for 3D annotations and allowing more flexible scene exploration.


<details>
  <summary>Details</summary>
Motivation: Existing AR methods for novel view synthesis require 3D annotations and user alignment, which are mentally taxing and restrict scene exploration. The paper aims to address these limitations.

Method: The authors propose using locally reconstructed light fields and visualizing errors through inserting new views to improve the AR experience.

Result: The error-peaking visualization method is less invasive, reduces user disappointment, and works well with fewer view samples in a mobile system.

Conclusion: The approach enhances novel view synthesis and supports larger scene reconstruction, like 3D Gaussian splatting.
...
TL;DR: The paper proposes EgoAdapt, a framework for efficient egocentric perception tasks with cross-modal distillation and policy learning, achieving significant efficiency gains without sacrificing performance.


<details>
  <summary>Details</summary>
Motivation: Modern perception models for egocentric tasks are effective but computationally expensive, making them hard to deploy in resource-limited settings.

Method: EgoAdapt uses cross-modal distillation and policy learning with an adaptable policy module for different tasks.

Result: The method reduces GMACs by up to 89.09%, parameters by 82.02%, and energy use by 9.6x, while maintaining or improving performance on three datasets.

Conclusion: EgoAdapt enables efficient inference across various egocentric perception tasks with substantial computational savings and competitive performance.
...
TL;DR: CL-Splats efficiently updates 3D scene representations in dynamic environments by using incremental Gaussian splatting with change detection, improving quality and enabling temporal analysis.


<details>
  <summary>Details</summary>
Motivation: The need for efficient and accurate updates in dynamic 3D environments for robotics, mixed reality, and embodied AI applications.

Method: CL-Splats uses a change-detection module to segment dynamic and static parts of a scene, allowing local optimization and avoiding full re-computation.

Result: CL-Splats provides efficient updates with better reconstruction quality than existing methods, supports storing past states, and enables new temporal analysis applications.

Conclusion: CL-Splats offers a strong foundation for real-time 3D scene reconstruction adaptations in dynamic settings.
...
TL;DR: The paper introduces an OCR system for Greek polytonic texts using CNNs and RNNs, improving accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Traditional OCR methods have limitations in recognizing Greek polytonic scripts, which need a more accurate and efficient solution.

Method: The system uses convolutional layers for feature extraction and recurrent layers for sequence learning to address the challenges of Greek polytonic texts.

Result: The approach offers significant improvements in accuracy and efficiency compared to traditional OCR methods.

Conclusion: The authors release the model as an open-source library and provide the OCR platform for academic use.
...
TL;DR: The paper proposes a deep-learning pipeline for automated myocardial scar segmentation using KL loss and data augmentation, showing better performance than existing models.


<details>
  <summary>Details</summary>
Motivation: Accurate segmentation of myocardial scars from cardiac MRI is crucial for clinical assessment and treatment planning, but existing methods struggle with label noise, data heterogeneity, and class imbalance.

Method: The authors propose a deep-learning pipeline that fine-tunes state-of-the-art models, utilizing Kullback-Leibler loss and extensive data augmentation to tackle challenges of label noise, data heterogeneity, and class imbalance.

Result: The model demonstrates accurate and smooth segmentation even with noisy labels, outperforming state-of-the-art models like nnU-Net, and shows strong generalizability on out-of-distribution test sets.
...
<details>
  <summary>Details</summary>
Motivation: Spurious correlations in visual data limit OOD performance, and existing methods only focus on image features, not across modalities.
...
Result: DiMPLe outperforms CoOp-OOD across 11 datasets, with 15.27 and 44.31 gains in base and novel class accuracy respectively.

Conclusion: DiMPLe improves generalization to novel classes and robustness to distribution shifts by disentangling features within and across modalities while maintaining alignment.
...
TL;DR: The paper introduces CoPa-SG, a synthetic scene graph dataset with precise ground truth and exhaustive relations, along with parametric and proto-relations to improve scene understanding and downstream applications.


<details>
  <summary>Details</summary>
Motivation: Current 2D scene graph methods lack accurate data, limiting their effectiveness. The paper aims to address this by creating a high-quality synthetic dataset with new relation concepts.

Method: The authors created CoPa-SG, a synthetic dataset with precise annotations. They introduced parametric relations (with parameters like angles/distance) and proto-relations (hypothetical relations for new objects).

Result: CoPa-SG provides a reliable dataset for training and evaluating scene graph models. The new relation types improved performance in downstream tasks like planning and reasoning.

Conclusion: CoPa-SG and its novel relation concepts offer a valuable resource for advancing 2D scene graph research and applications.
...
TL;DR: The paper introduces XVerse, a new model for controlling text-to-image generation with multiple subjects, avoiding artifacts and attribute entanglement.


<details>
  <summary>Details</summary>
Motivation: The motivation is to achieve fine-grained control over subject identity and semantic attributes (like pose, style, lighting) in text-to-image generation, especially for scenes with multiple subjects, while maintaining editability and coherence of DiTs.

Method: XVerse transforms reference images into offsets for token-specific text-stream modulation, enabling precise and independent control of specific subjects without disrupting image latents or features.

Result: XVerse provides high-fidelity, editable multi-subject image synthesis with robust control over individual subject characteristics and semantic attributes, enhancing personalized and complex scene generation.

Conclusion: The proposed model significantly improves the capabilities of generating personalized and complex scenes by addressing the issues of artifacts and attribute entanglement in multi-subject controlled generation.
...
TL;DR: This paper introduces Radial Cross-Modal Embeddings (RCME), a framework for explicitly modeling transitive entailment in vision-language models, improving hierarchical representation and performance in tasks like species classification and retrieval.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenge of learning hierarchical structures in vision-language models by explicitly modeling transitive entailment, which previous methods failed to do, leading to limitations in capturing order and semantics relationships.

Method: The method involves introducing RCME, a framework that optimizes for the partial order of concepts within vision-language models, enabling explicit transitivity-enforced entailment.

Result: The result shows that models using RCME outperform existing state-of-the-art models in hierarchical species classification and hierarchical retrieval tasks.

Conclusion: The conclusion is that RCME effectively enhances the hierarchical representation in vision-language foundation models, demonstrating improved performance through experiments.
...
TL;DR: Introduce WAFT, a new optical flow method that replaces cost volume with high-res warping, offering better accuracy and lower memory use, and outperforms existing methods on benchmarks.


<details>
  <summary>Details</summary>
Motivation: To challenge the conventional reliance on cost volumes in optical flow methods and provide a more efficient alternative.

Method: Warping-Alone Field Transforms (WAFT) which uses high-resolution warping instead of cost volumes, with a simple and flexible meta-architecture.

Result: WAFT ranks 1st on Spring and KITTI benchmarks, shows best zero-shot generalization on KITTI, and is up to 4.1x faster than similar methods.

Conclusion: WAFT provides a novel approach to optical flow by replacing cost volumes, demonstrating superior performance and efficiency.
...
TL;DR: This paper introduces a dynamic context-aware prompt recommendation system for domain-specific AI applications, combining contextual analysis, retrieval-augmented knowledge, hierarchical skills, and adaptive ranking to improve prompt quality.


<details>
  <summary>Details</summary>
Motivation: LLM applications are sensitive to prompt quality, which is challenging to achieve for domain-specific uses. The motivation is to create a system that provides relevant and actionable prompts.

Method: The system uses behavioral telemetry and a two-stage hierarchical reasoning process to select and rank skills, along with predefined and adaptive templates enhanced by few-shot learning.

Result: Experiments on real-world datasets show high usefulness and relevance, confirmed by automated and expert evaluations.

Conclusion: The approach effectively enhances prompt quality for domain-specific AI applications through dynamic context-aware recommendations.
...
TL;DR: Paper proposes a framework to analyze how language model advice propagates in society and introduces a dataset for testing long-term safety.


<details>
  <summary>Details</summary>
Motivation: To ensure language model agents have beneficial societal impact, we need to understand the implications of their suggestions.

Method: Framework for projecting model-generated advice propagation and dataset of 100 indirect harm scenarios.

Result: Over 20% improvement on the new dataset and over 70% win rate against baselines on safety benchmarks.

Conclusion: The approach shows promise for developing safer agents by considering long-term societal impacts.
...
TL;DR: The paper introduces IXAII, an interactive explainable AI system that offers multiple methods and user-tailored views, improving transparency and user agency.
...
Method: Developed IXAII, an interactive system using LIME, SHAP, Anchors, and DiCE for explanations, with tailored views for five user groups.

Result: Evaluation via expert and lay user interviews showed IXAII increases transparency by providing diverse explanations and visualization options.

Conclusion: IXAII bridges gaps between explainable AI methods, interactivity, and implementation, offering a new approach to AI explanation and human-AI interaction.
...
TL;DR: This paper introduces LUCARIO, a benchmark for probabilistic QA over tables, and a framework that uses Bayesian Networks and LLMs to improve reasoning under uncertainty.
...
Method: The method involves inducing Bayesian Networks from tables, translating queries into probabilistic ones, and using LLMs to generate answers.

Result: The framework shows significant improvement over baselines in handling probabilistic QA.

Conclusion: Hybrid symbolic-neural reasoning is effective for probabilistic QA over large tabular data.
...
TL;DR: This paper evaluates large language models (LLMs) using a social science instrument called the Violent Behavior Vignette Questionnaire (VBVQ) and finds that LLMs' surface-level text generation often differs from their internal preference for violence, with violent tendencies varying across demographics in ways that contradict established social science findings.


<details>
  <summary>Details</summary>
Motivation: The motivation is to examine the ability of LLMs to reason about morally ambiguous scenarios and to assess potential biases in their responses to violent content.

Method: The method involves using the VBVQ, a validated social science instrument, and introducing persona-based prompting to vary race, age, and geographic identity within the US. Six LLMs from different contexts are evaluated in a unified zero-shot setting.

Result: The results show that LLMs' surface-level text generation often diverges from their internal preference for violent responses, and their violent tendencies vary across demographics, frequently contradicting established findings in criminology, social science, and psychology.

Conclusion: The conclusion emphasizes the need to consider demographic variations in LLMs' violent tendencies and the importance of evaluating their moral reasoning in real-world scenarios, as their behavior may not align with human expectations or existing social science theories.
...
TL;DR: ComRAG is a new framework for real-time industrial Community Question Answering (CQA) that combines static knowledge with dynamic historical QA pairs using a centroid-based memory mechanism, showing significant improvements in vector similarity, latency, and chunk growth.


<details>
  <summary>Details</summary>
Motivation: The motivation is to effectively use historical interactions and domain knowledge in real-time CQA systems, which existing methods have failed to do properly.

Method: ComRAG uses a centroid-based memory mechanism to integrate static and dynamic knowledge for retrieval and generation.

Result: Evaluated on three industrial datasets, ComRAG outperforms baselines with 25.9% improvement in vector similarity, 8.7-23.3% reduced latency, and 20.23% to 2.06% reduced chunk growth.

Conclusion: ComRAG is a promising framework for industrial CQA, offering efficient storage and better performance through its unique memory mechanism.
...
TL;DR: Progtuning is a new framework that makes fine-tuning Transformers more efficient by reducing the number of blocks updated, saving resources without losing performance.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency of fine-tuning large Transformer models by addressing the uneven contribution of different blocks and avoiding unnecessary parameter updates.

Method: Progtuning combines progressive learning with parameter-efficient fine-tuning, gradually decreasing the number of transformer blocks that are updated based on their contribution.

Result: Progtuning reduces the number of updated parameters by about 25% while maintaining good performance and showing high adaptability across different scenarios.

Conclusion: Progtuning offers an efficient way to fine-tune Transformers by optimizing resource use through progressive block selection, making it a valuable approach for large model adaptation.
...
TL;DR: This paper explores the detection of fake text generated by large language models, finding that statistical classifiers can effectively identify such text even as models grow larger, with some models like Gemini showing improved deceptiveness but others like GPT not.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenge of detecting fake text generated by large language models, which has implications for domains like academic writing, product reviews, and political news.

Method: The method involves examining the ability of statistical classifiers to detect fake text in the style of classical detective fiction.

Result: Over a 0.5 version increase, Gemini showed improved ability to generate deceptive text, while GPT did not.

Conclusion: Reliable detection of fake text may remain feasible even for larger models, though new architectures could enhance their deceptiveness.
...
TL;DR: This paper explores using a text-only autoregressive language model to extract referring expressions from visually grounded dialogue, showing that linguistic context alone can be effective but also highlighting the multimodal nature of the task.


<details>
  <summary>Details</summary>
Motivation: The motivation is to investigate how much linguistic context can inform the detection of mentions with visually perceivable referents in dialogue without relying on visual data.

Method: Adapting a pretrained LLM to annotate mention spans in conversations by using next-token prediction to mark span boundaries.

Result: A text-only approach with a moderate LLM, small datasets, and parameter-efficient tuning was effective, indicating the importance of linguistic context.
...
TL;DR: The paper studies how well reinforcement learning works for tuning big language models when they move from offline to semi-online and fully online setups, testing both tasks that can be checked (like math) and those that can't (like following instructions). They found that online and semi-online methods perform similarly and better than offline ones. Also, using both types of tasks together helps improve results.


<details>
  <summary>Details</summary>
Motivation: To explore the effectiveness of reinforcement learning in adapting large language models across different operational regimes (offline, semi-online, online) and task types (verifiable vs. non-verifiable), aiming to improve their performance through better training dynamics and hyperparameter strategies.

Method: The paper compares online and semi-online Direct Preference Optimization and Group Reward Policy Optimization methods on verifiable math tasks and non-verifiable instruction following tasks. They analyze training dynamics and hyperparameter selection to optimize results and test multi-task learning with both reward types.

Result: Online and semi-online methods show similar performance and convergence, outperforming offline methods. Multi-task learning using both verifiable and non-verifiable rewards improves performance across all task types.

Conclusion: Reinforcement learning methods, particularly online and semi-online approaches, are effective for finetuning large language models. Combining verifiable and non-verifiable tasks in multi-task learning enhances overall performance.
...
TL;DR: Introduces skLEP, a comprehensive benchmark for Slovak NLU models with nine tasks and resources for evaluation and future research.


<details>
  <summary>Details</summary>
Motivation: There is a lack of specialized benchmarks for Slovak NLU models, hindering systematic evaluation and research progress.

Method: Curated new Slovak datasets and translated existing English NLU resources to create the skLEP benchmark, then evaluated various models on these tasks.

Result: The paper presents the first systematic evaluation of Slovak-specific, multilingual, and English pre-trained models using skLEP, along with released data, toolkit, and leaderboard.

Conclusion: skLEP aims to promote reproducibility and future research in Slovak NLU by providing a thorough benchmark and supporting resources.
...
### [166] [Generative Blocks World: Moving Things Around in Pictures](https://arxiv.org/abs/2506.20703)
*Vaibhav Vavilala,Seemandhar Jain,Rahul Vasanth,D. A. Forsyth,Anand Bhattad*

Main category: cs.GR

TL;DR: The paper introduces Generative Blocks World, a method for editing generated images by manipulating 3D geometric primitives, followed by image generation with depth and texture hints, improving visual fidelity and editability.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enable more flexible and accurate editing of generated images by using 3D geometric primitives instead of traditional pixel-based methods.

Method: The method involves representing scenes as assemblies of convex 3D primitives, allowing editing of entire structures or details. Then, a flow-based image generation method is used, conditioned on depth and a texture hint that considers modified 3D primitives.

Result: The results show that the approach outperforms prior works in visual fidelity, editability, and compositional generalization through quantitative and qualitative experiments.

Conclusion: The conclusion is that Generative Blocks World provides a more effective way to edit and generate images by leveraging 3D geometric abstractions and improved texture hints.
...
### [167] [3DGH: 3D Head Generation with Composable Hair and Face](https://arxiv.org/abs/2506.20875)
...
### [171] [Transformer-Based Spatial-Temporal Counterfactual Outcomes Estimation](https://arxiv.org/abs/2506.21154)
*He Li,Haoang Chi,Mingyu Liu,Wanrong Huang,Liyang Xu,Wenjing Yang*

Main category: stat.ME

TL;DR: This paper introduces a new framework using Transformers to estimate counterfactual outcomes with spatial-temporal data, showing better performance than traditional methods in simulations and real-world applications like analyzing conflict's impact on forest loss in Colombia.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve counterfactual outcome estimation in spatial-temporal contexts, as traditional statistical models have limitations in performance and generalization.

Method: The method involves a novel framework leveraging Transformers for counterfactual estimation, ensuring consistency and asymptotic normality under mild assumptions.

Result: Simulation experiments demonstrate superior estimation capability compared to baseline methods; real data experiments show the causal effect of conflicts on forest loss in Colombia.

Conclusion: The proposed framework effectively enhances counterfactual estimation for spatial-temporal data, offering better performance and practical insights in real-world scenarios.
...
### [172] [The final solution of the Hitchhiker's problem #5](https://arxiv.org/abs/2506.20672)
...
### [173] [Lower Bounds on the Size of Markov Equivalence Classes](https://arxiv.org/abs/2506.20933)
*Erik Jahn,Frederick Eberhardt,Leonard J. Schulman*

Main category: stat.ML

TL;DR: The paper shows that relaxing assumptions in causal discovery leads to exponentially larger Markov equivalence classes.


<details>
  <summary>Details</summary>
Motivation: To understand the limits of causal graph learning from observational data, especially when standard assumptions are not met.

Method: Theoretical analysis and proofs of lower bounds on the expected size of Markov equivalence classes under different graph settings.

Result: Exponentially large lower bounds for the expected size of Markov equivalence classes when assumptions of acyclicity, causal sufficiency, or uniform model prior are relaxed.

Conclusion: Relaxing standard assumptions in causal discovery significantly increases the ambiguity in causal graph identification, highlighting the importance of these assumptions for accurate learning.
...
### [174] [Hyperspherical Variational Autoencoders Using Efficient Spherical Cauchy Distribution](https://arxiv.org/abs/2506.21278)
...
### [175] [Wild refitting for black box prediction](https://arxiv.org/abs/2506.21460)
*Martin J. Wainwright*
...
### [176] [On Uniform Weighted Deep Polynomial approximation](https://arxiv.org/abs/2506.21306)
...
### [177] [Central limit theory for Peaks-over-Threshold partial sums of long memory linear time series](https://arxiv.org/abs/2506.20789)
...
### [178] [IMC-PINN-FE: A Physics-Informed Neural Network for Patient-Specific Left Ventricular Finite Element Modeling with Image Motion Consistency and Biomechanical Parameter Estimation](https://arxiv.org/abs/2506.20696)
...
### [179] [ResQ: A Novel Framework to Implement Residual Neural Networks on Analog Rydberg Atom Quantum Computers](https://arxiv.org/abs/2506.21537)
*Nicholas S. DiBrita,Jason Han,Tirthak Patel*

Main category: quant-ph

TL;DR: This paper explores the use of analog Rydberg atom quantum computers for neural ODE-based ResNets, introducing ResQ to optimize their dynamics for machine learning classification tasks.


<details>
  <summary>Details</summary>
Motivation: To leverage quantum computing's potential to accelerate machine learning, specifically by applying neural ODE-based ResNets to analog Rydberg atom quantum computers, which haven't been explored before.

Method: The authors analyze the suitability of analog Rydberg atom quantum computers for ResNets and propose ResQ, a framework that optimizes Rydberg atom dynamics using analog quantum neural ODEs for classification tasks.

Result: The paper presents insights on why Rydberg atom quantum computers are well-suited for ResNets and introduces ResQ as a novel framework for optimizing their dynamics in machine learning classification.

Conclusion: Analog Rydberg atom quantum computers are promising for ResNets due to their inherent continuous dynamics, and ResQ offers a new approach to harness this for efficient machine learning classification.
...
### [180] [Parallels Between VLA Model Post-Training and Human Motor Learning: Progress, Challenges, and Trends](https://arxiv.org/abs/2506.20966)
...
### [181] [V2X-REALM: Vision-Language Model-Based Robust End-to-End Cooperative Autonomous Driving with Adaptive Long-Tail Modeling](https://arxiv.org/abs/2506.21041)
...
### [185] [CovDocker: Benchmarking Covalent Drug Design with Tasks, Datasets, and Solutions](https://arxiv.org/abs/2506.21085)
...
### [186] [DRAGON: Distributional Rewards Optimize Diffusion Generative Models](https://arxiv.org/abs/2504.15217)
...
### [187] [Exploring Adapter Design Tradeoffs for Low Resource Music Generation](https://arxiv.org/abs/2506.21298)
...
### [188] [A Hierarchical Deep Learning Approach for Minority Instrument Detection](https://arxiv.org/abs/2506.21167)
*Dylan Sechet,Francesca Bugiotti,Matthieu Kowalski,Edouard d'Hérouville,Filip Langiewicz*

Main category: cs.SD

TL;DR: This paper explores hierarchical classification for musical instrument recognition, aiming to improve coarse-level detection by bridging detailed identification and group-level recognition using the MedleyDB dataset.


<details>
  <summary>Details</summary>
Motivation: Identifying instrument activities in audio is crucial for music retrieval, cataloging, and discovery. Existing deep learning approaches focus on well-resourced instrument classes, but hierarchical classification can handle limited annotations in orchestral music.

Method: The paper evaluates a hierarchical classification system based on Hornbostel-Sachs taxonomy using the MedleyDB dataset, testing various strategies to integrate hierarchy into models for hierarchical music prediction.

Result: The study demonstrates more reliable coarse-level instrument detection by bridging detailed instrument identification and group-level recognition, suggesting potential for future advancements in the field.

Conclusion: Hierarchical classification offers a promising approach for musical instrument recognition, especially in scenarios with limited fine-grained data, by improving group-level detection through structured modeling.
...
### [189] [Integrating Vehicle Acoustic Data for Enhanced Urban Traffic Management: A Study on Speed Classification in Suzhou](https://arxiv.org/abs/2506.21269)
...
### [190] [SmoothSinger: A Conditional Diffusion Model for Singing Voice Synthesis with Multi-Resolution Architecture](https://arxiv.org/abs/2506.21478)
...
### [191] [Enhancing Homophily-Heterophily Separation: Relation-Aware Learning in Heterogeneous Graphs](https://arxiv.org/abs/2506.20980)
...
### [192] [Proof of The TAP Free Energy for High-Dimensional Linear Regression with Spherical Priors at All Temperatures](https://arxiv.org/abs/2506.20768)
*Zhiyuan Yu,Jingbo Liu*

Main category: math.ST

TL;DR: This paper proves the asymptotic correctness of the TAP free energy approximation for Bayesian linear regression under uniform spherical priors at any temperature.


<details>
  <summary>Details</summary>
Motivation: Traditional mean-field VI methods fail to capture complex dependencies and are inconsistent in high-dimensional settings. The TAP approximation is conjectured to be consistent but previous results only applied to high-temperature regimes.

Method: The key method is finding a ridge regression functional that dominates the TAP free energy.

Result: The paper establishes the asymptotic correctness of TAP free energy approximation for Bayesian linear regression under uniform spherical priors at any temperature.

Conclusion: The work provides a theoretical guarantee for the TAP approximation in Bayesian linear regression, extending previous results beyond high-temperature regimes.
...
### [193] [Prokhorov Metric Convergence of the Partial Sum Process for Reconstructed Functional Data](https://arxiv.org/abs/2506.21172)
...
### [194] [Bayes linear estimator in the general linear model](https://arxiv.org/abs/2506.21192)
*Hirai Mukasa*

Main category: math.ST

TL;DR: This paper discusses Bayes linear estimators, their properties, and conditions under which they coincide or lead to equivalent residual sums of squares.


<details>
  <summary>Details</summary>
Motivation: To understand the theoretical properties of Bayes linear estimators and their relationships with other non-unbiased estimators like ridge, shrinkage, and fractional rank estimators.

Method: The paper uses mathematical proofs to establish the linear completeness and sufficiency of Bayes linear estimators, derives conditions for their coincidence, and obtains equivalence conditions for residual sums of squares.

Result: Bayes linear estimators are linearly complete but not necessarily linearly sufficient. A necessary and sufficient condition for two Bayes estimators to coincide is found, and an equivalence condition for residual sums of squares is established.

Conclusion: The study provides a deeper understanding of Bayes linear estimators, their connections to other estimation methods, and key conditions that govern their behavior in statistical analysis.
...
### [195] [Causal inference via implied interventions](https://arxiv.org/abs/2506.21501)
...
### [196] [Robust Alignment via Partial Gromov-Wasserstein Distances](https://arxiv.org/abs/2506.21507)
...
### [197] [Asymptotic Inference for Exchangeable Gibbs Partition](https://arxiv.org/abs/2506.21527)
*Takuya Koriyama*
...
### [198] [Detecting weighted hidden cliques](https://arxiv.org/abs/2506.21543)
...
### [200] [Exploring the Effects of Chatbot Anthropomorphism and Human Empathy on Human Prosocial Behavior Toward Chatbots](https://arxiv.org/abs/2506.20748)
...
### [201] [A Systematic Review of Human-AI Co-Creativity](https://arxiv.org/abs/2506.21333)
...
### [202] [Multimodal LLMs for Visualization Reconstruction and Understanding](https://arxiv.org/abs/2506.21319)
*Can Liu,Chunlin Da,Xiaoxiao Long,Yuxiao Yang,Yu Zhang,Yong Wang*

Main category: cs.HC

TL;DR: This paper introduces a new dataset and trains multimodal LLMs to better understand visualizations by combining chart images with vectorized data and encoding schemes.


<details>
  <summary>Details</summary>
Motivation: Visualizations are important for data communication, but current models can't effectively decode data-to-visual mappings or extract structured info.

Method: The paper proposes a vector format for compact and accurate reconstruction of visualizations, using chart images and vectorized representations.

Result: Experiments show improved data extraction accuracy and chart reconstruction quality.

Conclusion: The study suggests that training multimodal visualization LLMs with vectorized data and encoding schemes enhances understanding of visualizations.
...
### [203] [Poster: Enhancing GNN Robustness for Network Intrusion Detection via Agent-based Analysis](https://arxiv.org/abs/2506.20806)
...
### [204] [ZKPROV: A Zero-Knowledge Approach to Dataset Provenance for Large Language Models](https://arxiv.org/abs/2506.20915)
...
### [205] [PhishKey: A Novel Centroid-Based Approach for Enhanced Phishing Detection Using Adaptive HTML Component Extraction](https://arxiv.org/abs/2506.21106)
*Felipe Castaño,Eduardo Fidalgo,Enrique Alegre,Rocio Alaiz-Rodríguez,Raul Orduna,Francesco Zola*

Main category: cs.CR

TL;DR: PhishKey is a new phishing detection method using CNN and CAPE to combine URL and HTML features, achieving high accuracy and robustness against attacks.


<details>
  <summary>Details</summary>
Motivation: Phishing attacks are a major cybersecurity threat that rapidly evolve to bypass detection and exploit humans, necessitating more adaptable and efficient solutions.

Method: PhishKey uses automatic feature extraction from hybrid sources, combining character-level CNN for URL classification and CAPE for HTML content at the word level.

Result: PhishKey achieves up to 98.70% F1 Score and shows strong resistance to adversarial attacks with minimal performance loss.

Conclusion: PhishKey effectively addresses phishing detection challenges through integrated feature extraction and ensemble methods, offering a robust solution against evolving threats.
...
### [206] [ClusterRCA: Network Failure Diagnosis in HPC Systems Using Multimodal Data](https://arxiv.org/abs/2506.20673)
*Yongqian Sun,Xijie Pan,Xiao Xiong,Lei Tao,Jiaju Wang,Shenglin Zhang,Yuan Yuan,Yuqi Li,Kunlin Jian*

Main category: cs.DC

TL;DR: This paper proposes ClusterRCA, a novel framework for network failure diagnosis in HPC systems using multimodal data and combining classifier-based and graph-based approaches to achieve high accuracy and robust performance.


<details>
  <summary>Details</summary>
Motivation: Existing methods for network failure diagnosis are not suitable for HPC systems due to data heterogeneity and lack of accuracy.

Method: ClusterRCA uses multimodal data from NIC pairs, combines classifier-based and graph-based methods, constructs a failure graph, and performs a customized random walk to find root causes.

Result: Experiments on datasets from a top-tier HPC vendor show ClusterRCA has high accuracy and robust performance in diagnosing network failures.

Conclusion: ClusterRCA effectively localizes culprit nodes and determines failure types in HPC systems, making it a reliable solution for network failure diagnosis.
...
### [207] [Utility-Driven Speculative Decoding for Mixture-of-Experts](https://arxiv.org/abs/2506.20675)
...
### [208] [Evaluating PDE discovery methods for multiscale modeling of biological signals](https://arxiv.org/abs/2506.20694)
...
### [209] [Global and Local Contrastive Learning for Joint Representations from Cardiac MRI and ECG](https://arxiv.org/abs/2506.20683)
...
### [210] [U-R-VEDA: Integrating UNET, Residual Links, Edge and Dual Attention, and Vision Transformer for Accurate Semantic Segmentation of CMRs](https://arxiv.org/abs/2506.20689)
...
### [211] [A Novel Framework for Integrating 3D Ultrasound into Percutaneous Liver Tumour Ablation](https://arxiv.org/abs/2506.21162)
...
### [212] [Development of MR spectral analysis method robust against static magnetic field inhomogeneity](https://arxiv.org/abs/2506.20897)
...
### [213] [Uncover Treasures in DCT: Advancing JPEG Quality Enhancement by Exploiting Latent Correlations](https://arxiv.org/abs/2506.21171)
...
### [214] [GANet-Seg: Adversarial Learning for Brain Tumor Segmentation with Hybrid Generative Models](https://arxiv.org/abs/2506.21245)
*Qifei Cui,Xinyu Lu*

Main category: eess.IV

TL;DR: This paper presents a new framework for brain tumor segmentation using pre-trained GANs and Unet, improving precision with anomaly detection and adversarial loss, and showing effectiveness on BraTS dataset.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenge of limited annotated datasets for brain tumor segmentation by leveraging multi-modal MRI data and synthetic image augmentation.

Method: The method combines a global anomaly detection module with a refined mask generation network using pre-trained GANs and Unet architectures, employing adversarial loss constraints for iterative enhancement of segmentation precision.
...
Conclusion: The conclusion is that the proposed scalable method reduces dependency on fully annotated data, making it suitable for real-world clinical applications.
...
### [215] [Lightweight Physics-Informed Zero-Shot Ultrasound Plane Wave Denoising](https://arxiv.org/abs/2506.21499)
...
### [216] [Exploring the Design Space of 3D MLLMs for CT Report Generation](https://arxiv.org/abs/2506.21535)
...
### [217] [Agile Management for Machine Learning: A Systematic Mapping Study](https://arxiv.org/abs/2506.20759)
...
### [218] [Generating Reliable Adverse event Profiles for Health through Automated Integrated Data (GRAPH-AID): A Semi-Automated Ontology Building Approach](https://arxiv.org/abs/2506.20851)
...
### [219] [Engineering RAG Systems for Real-World Applications: Design, Development, and Evaluation](https://arxiv.org/abs/2506.20869)
...
### [220] [Complex Model Transformations by Reinforcement Learning with Uncertain Human Guidance](https://arxiv.org/abs/2506.20883)
...
### [221] [How Good Are Synthetic Requirements ? Evaluating LLM-Generated Datasets for AI4RE](https://arxiv.org/abs/2506.21138)
...
### [222] [$T^3$: Multi-level Tree-based Automatic Program Repair with Large Language Models](https://arxiv.org/abs/2506.21211)
*Quanming Liu,Xupeng Bu,Zhichao Yan,Ru Li*

Main category: cs.SE

TL;DR: This paper evaluates CoT techniques in APR and proposes T^3, a framework that combines LLMs with tree search to improve repair solution precision.


<details>
  <summary>Details</summary>
Motivation: To address the insufficiency of applying CoT techniques in APR due to complex logic and multi-step reasoning requirements.

Method: Systematic evaluation of common CoT techniques and proposal of T^3 framework integrating LLMs and tree search.

Result: T^3 effectively improves the precision of generating candidate repair solutions and provides guidance for optimizing sample selection and repair strategies.
...
### [223] [Real-time and personalized product recommendations for large e-commerce platforms](https://arxiv.org/abs/2506.21368)
*Matteo Tolloso,Davide Bacciu,Shahab Mokarizadeh,Marco Varesi*

Main category: cs.IR

TL;DR: The paper introduces a real-time, personalized product recommendation method for e-commerce using GNNs and parsimonious learning, showing effectiveness in fashion retail with fast response times.


<details>
  <summary>Details</summary>
Motivation: The motivation is to create accurate, scalable, and fast recommendation systems for large e-commerce platforms, especially in fashion retail where user interactions are complex and require real-time personalization.

Method: The method combines Graph Neural Networks (GNNs) with parsimonious learning to enable efficient and accurate real-time product recommendations.

Result: The results show that the approach effectively forecasts purchase sequences and handles multi-interaction scenarios, providing efficient personalized recommendations under real-world constraints.

Conclusion: The conclusion states that the proposed methodology is effective for real-time personalized recommendations in large e-commerce platforms, particularly in fashion retail, due to its accuracy, scalability, and low response time.
...
### [224] [Progressive Size-Adaptive Federated Learning: A Comprehensive Framework for Heterogeneous Multi-Modal Data Systems](https://arxiv.org/abs/2506.20685)
...
### [225] [Diffusion Tree Sampling: Scalable inference-time alignment of diffusion models](https://arxiv.org/abs/2506.20701)
...
### [226] [On Convolutions, Intrinsic Dimension, and Diffusion Models](https://arxiv.org/abs/2506.20705)
...
### [227] [Test-time Scaling Techniques in Theoretical Physics -- A Comparison of Methods on the TPBench Dataset](https://arxiv.org/abs/2506.20729)
*Zhiqi Gao,Tianyi Li,Yurii Kvasiuk,Sai Chaitanya Tadepalli,Maja Rudolph,Daniel J. H. Chung,Frederic Sala,Moritz Münchmeyer*

Main category: cs.LG

TL;DR: This paper explores the application of test-time scaling techniques from mathematical reasoning to theoretical physics, introducing a symbolic weak-verifier framework that improves performance on TPBench and AIME.


<details>
  <summary>Details</summary>
Motivation: The motivation is to determine if test-time scaling methods successful in mathematical benchmarks like AIME can also enhance LLMs' performance in advanced theoretical physics, where problem structures differ.

Method: The paper evaluates existing test-time scaling methods on TPBench, develops a novel symbolic weak-verifier framework to exploit physics problem structures, and tests this method on both TPBench and AIME.

Result: The symbolic weak-verifier framework significantly outperforms previous test-time scaling methods on TPBench and shows effectiveness on AIME for mathematical problems.

Conclusion: The study concludes that step-wise symbolic verification is effective for complex scientific problems, suggesting potential for broader application beyond mathematical benchmarks.
...
### [228] [Stochastic Parameter Decomposition](https://arxiv.org/abs/2506.20790)
...
### [229] [GPU Kernel Scientist: An LLM-Driven Framework for Iterative Kernel Optimization](https://arxiv.org/abs/2506.20807)
...
### [230] [FINN-GL: Generalized Mixed-Precision Extensions for FPGA-Accelerated LSTMs](https://arxiv.org/abs/2506.20810)
...
### [231] [Leaner Training, Lower Leakage: Revisiting Memorization in LLM Fine-Tuning with LoRA](https://arxiv.org/abs/2506.20856)
*Fei Wang,Baochun Li*

Main category: cs.LG

TL;DR: This paper studies how memorization in large language models (LLMs) affects data extraction attacks, especially during LoRA fine-tuning. It finds that factors like model scale and data duplication impact memorization differently in LoRA compared to full fine-tuning, showing LoRA reduces risks while keeping good performance.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand memorization in fine-tuning, particularly for LoRA, which is a popular parameter-efficient method, and its implications for data extraction attacks.

Method: The method involves re-examining memorization in fine-tuning, using a relaxed similarity-based metric to assess memorization risks in LoRA compared to full fine-tuning.

Result: The result shows that LoRA significantly reduces memorization risks compared to full fine-tuning, while still maintaining strong task performance.

Conclusion: The conclusion is that LoRA is a safer fine-tuning method in terms of memorization risks, making it less vulnerable to data extraction attacks, while preserving effectiveness on tasks.
...
### [232] [Omniwise: Predicting GPU Kernels Performance with LLMs](https://arxiv.org/abs/2506.20886)
...
### [233] [SharpZO: Hybrid Sharpness-Aware Vision Language Model Prompt Tuning via Forward-Only Passes](https://arxiv.org/abs/2506.20990)
...
### [234] [Enhancing LLM Tool Use with High-quality Instruction Data from Knowledge Graph](https://arxiv.org/abs/2506.21071)
*Jingwei Wang,Zai Zhang,Hao Qian,Chunjing Gan,Binbin Hu,Ziqi Liu,Zhiqiang Zhang,Jun Zhou,Bin Shi,Bo Dong*

Main category: cs.LG

TL;DR: This paper proposes using knowledge graphs to generate high-quality instruction data for LLMs, improving their tool utilization and problem-solving abilities with minimal synthetic data.


<details>
  <summary>Details</summary>
Motivation: Previous methods for teaching LLMs to use tools have relied on low-quality instruction data generated by the models themselves, which limits their effectiveness.

Method: Extracting query pathways from knowledge graphs, translating entity relationships into tools, and parsing query pathways into solution steps to create synthetic instruction data.

Result: Fine-tuning LLMs with a small sample of the synthetic data significantly enhances their tool utilization and overall capabilities.

Conclusion: Using knowledge graphs for instruction data generation is a promising approach to improve LLMs' ability to use tools effectively.
...
### [235] [Learning to Skip the Middle Layers of Transformers](https://arxiv.org/abs/2506.21103)
...
### [236] [LLM-guided Chemical Process Optimization with a Multi-Agent Approach](https://arxiv.org/abs/2506.20921)
...
### [237] [Interpretable Representation Learning for Additive Rule Ensembles](https://arxiv.org/abs/2506.20927)
...
### [238] [Complexity-aware fine-tuning](https://arxiv.org/abs/2506.21220)
...
### [239] [DiLoCoX: A Low-Communication Large-Scale Training Framework for Decentralized Cluster](https://arxiv.org/abs/2506.21263)
...
### [240] [Antibody Design and Optimization with Multi-scale Equivariant Graph Diffusion Models for Accurate Complex Antigen Binding](https://arxiv.org/abs/2506.20957)
...
### [241] [Latent Prototype Routing: Achieving Near-Perfect Load Balancing in Mixture-of-Experts](https://arxiv.org/abs/2506.21328)
*Jiajie Yang*
...
### [242] [Scalable Bayesian Low-Rank Adaptation of Large Language Models via Stochastic Variational Subspace Inference](https://arxiv.org/abs/2506.21408)
...
### [243] [Strict Subgoal Execution: Reliable Long-Horizon Planning in Hierarchical Reinforcement Learning](https://arxiv.org/abs/2506.21039)
*Jaebak Hwang,Sanghyeon Lee,Jeongmo Kim,Seungyul Han*

Main category: cs.LG

TL;DR: SSE is a new graph-based RL method that improves long-horizon goal-conditioned tasks by ensuring subgoals are reachable and using an exploration policy to find underexplored areas, leading to better performance.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenges in long-horizon goal-conditioned RL where goals are distant and rewards are sparse, which existing methods like hierarchical and graph-based approaches struggle with due to subgoal infeasibility and inefficiency.

Method: The method involves a graph-based hierarchical RL framework called SSE that enforces single-step subgoal reachability through structural constraints on high-level decisions. It uses a decoupled exploration policy to explore underexplored goal spaces and a failure-aware path refinement to adjust edge costs based on low-level success rates.

Result: SSE outperforms existing methods in long-horizon benchmarks in terms of efficiency and success rate.

Conclusion: SSE provides a more effective solution for goal-conditioned RL tasks by ensuring subgoal feasibility and improving exploration and planning efficiency.
...
### [244] [Efficient Skill Discovery via Regret-Aware Optimization](https://arxiv.org/abs/2506.21044)
...
### [245] [FeDa4Fair: Client-Level Federated Datasets for Fairness Evaluation](https://arxiv.org/abs/2506.21095)
...
### [246] [Interpretable Hierarchical Concept Reasoning through Attention-Guided Graph Learning](https://arxiv.org/abs/2506.21102)
...
### [247] [Robust Policy Switching for Antifragile Reinforcement Learning for UAV Deconfliction in Adversarial Environments](https://arxiv.org/abs/2506.21127)
...
### [248] [Curriculum-Guided Antifragile Reinforcement Learning for Secure UAV Deconfliction under Observation-Space Attacks](https://arxiv.org/abs/2506.21129)
...
### [249] [DBConformer: Dual-Branch Convolutional Transformer for EEG Decoding](https://arxiv.org/abs/2506.21140)
...
### [250] [Linearity-based neural network compression](https://arxiv.org/abs/2506.21146)
...
### [251] [rQdia: Regularizing Q-Value Distributions With Image Augmentation](https://arxiv.org/abs/2506.21367)
*Sam Lerman,Jing Bi*
...
### [252] [Pay Attention to Small Weights](https://arxiv.org/abs/2506.21374)
...
### [253] [Temporal-Aware Graph Attention Network for Cryptocurrency Transaction Fraud Detection](https://arxiv.org/abs/2506.21382)
...
### [254] [Optimising 4th-Order Runge-Kutta Methods: A Dynamic Heuristic Approach for Efficiency and Low Storage](https://arxiv.org/abs/2506.21465)
...
### [255] [Process mining-driven modeling and simulation to enhance fault diagnosis in cyber-physical systems](https://arxiv.org/abs/2506.21502)
...
### [256] [mTSBench: Benchmarking Multivariate Time Series Anomaly Detection and Model Selection at Scale](https://arxiv.org/abs/2506.21550)
...
### [257] [Universal and Efficient Detection of Adversarial Data through Nonuniform Impact on Network Layers](https://arxiv.org/abs/2506.20816)
...
### [258] [RL-Selector: Reinforcement Learning-Guided Data Selection via Redundancy Assessment](https://arxiv.org/abs/2506.21037)
...
### [259] [Personalized Federated Learning via Dual-Prompt Optimization and Cross Fusion](https://arxiv.org/abs/2506.21144)
...
### [260] [Automatic Reviewers Assignment to a Research Paper Based on Allied References and Publications Weight](https://arxiv.org/abs/2506.21331)
