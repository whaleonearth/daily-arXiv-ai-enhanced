...
TL;DR: This paper introduces a hybrid AI model combining ConvNeXt and EfficientNet for classifying falcon diseases, showing improved performance over traditional methods.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance health surveillance of falcons through accurate disease detection, crucial for their safety and effective hunting.

Method: The method involves using a hybrid model of ConvNeXt and EfficientNet for classifying three falcon conditions: Normal, Liver Disease, and Aspergillosis.

Result: The hybrid AI model demonstrated superior performance compared to traditional methods and individual models, as evidenced by high accuracy, precision, recall, and F1-score.

Conclusion: The study concludes that the hybrid model is a significant advancement in falcon disease detection, suggesting potential for future AI-driven avian healthcare solutions.
...
TL;DR: This paper surveys recent deep learning methods for multi-agent trajectory prediction, focusing on 2020-2024 studies, and discusses challenges and future directions.


<details>
  <summary>Details</summary>
Motivation: To provide a comprehensive review of advancements in multi-agent trajectory prediction using deep learning, highlighting challenges and future research directions.

Method: Categorizing existing methods based on architectural design, input representations, and prediction strategies, with emphasis on ETH/UCY benchmark evaluations.

Result: Reviews recent advancements in deep learning-based multi-agent trajectory prediction, categorizes methods, and identifies key challenges.

Conclusion: The survey offers insights into current methodologies, challenges, and future directions for multi-agent HTP, aiding in autonomous navigation and crowd modeling applications.
...
TL;DR: This paper presents a high-performance, low-latency video surveillance system tailored for resource-constrained devices, combining an entropy-based adaptive frame buffering algorithm with MobileNetV2 to achieve sub-50ms inference and over 92% accuracy.


<details>
  <summary>Details</summary>
Motivation: To develop a video surveillance system that operates efficiently on low-resource devices while maintaining high detection accuracy and compliance with data privacy regulations.

Method: Proposed an entropy-based adaptive frame buffering algorithm integrated with MobileNetV2 for efficient video processing.

Result: Achieved sub-50ms end-to-end inference latency on devices like Raspberry Pi, Amazon, and NVIDIA Jetson Nano, with over 92% detection accuracy and robustness to varying conditions.

Conclusion: The system is scalable, cost-effective, and meets strict data privacy standards, making it suitable for smart city and embedded security applications.
...
TL;DR: The paper introduces LRCN and Transformer-based models using GelSight sensor data to improve compliance prediction accuracy in robotics, showing better performance than baselines and highlighting challenges in estimating harder objects.


<details>
  <summary>Details</summary>
Motivation: Traditional compliance detection methods are not portable, scalable, or suitable for robotics due to reliance on expensive equipment. Neural networks with vision-based tactile sensors also have low accuracy.

Method: Proposed models using LRCNs and Transformers that utilize RGB tactile images and additional data from the GelSight sensor to predict compliance metrics.

Result: The models show significant performance improvement over baselines and effectively estimate compliance, though harder objects than the sensor are more challenging.

Conclusion: The paper concludes that the new models enhance compliance prediction accuracy, are effective for robotic applications, and identifies object hardness relative to the sensor as a key challenge.
...
TL;DR: This paper addresses training instability and codebook collapse in vector quantization by using Wasserstein distance to align feature and code vector distributions, leading to near 100% codebook utilization and reduced quantization errors.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the effectiveness of vector quantization in autoregressive models by solving training instability and codebook collapse issues.

Method: The method involves using the Wasserstein distance to align the distributions of features and code vectors, which helps in achieving better codebook utilization and reducing quantization errors.

Result: The result shows near 100% codebook utilization and a significant reduction in quantization error.

Conclusion: The conclusion is that employing Wasserstein distance for distribution alignment effectively addresses the issues in vector quantization, validated by both empirical and theoretical analyses.
...
TL;DR: ViMAT is an AI system for real-time visual monitoring of assembly tasks without needing rigid setups or markers.
...
Method: Combines a perception module with a reasoning module to infer actions from visual observations and task knowledge.

Result: Validated on LEGO and hydraulic press tasks, showing effectiveness in real-world scenarios with partial observations.

Conclusion: ViMAT provides a flexible solution for visual monitoring, improving safety and reducing reliance on markers or fixed setups.
...
TL;DR: This paper introduces MapFM, an enhanced end-to-end model for online vectorized HD map generation in autonomous driving, using foundation models and multi-task learning with BEV semantic segmentation.
...
Method: MapFM uses a foundation model to encode camera images, improving feature representation. It integrates auxiliary prediction heads for BEV semantic segmentation, enabling multi-task learning with contextual supervision.

Result: The multi-task learning approach leads to more comprehensive scene representation, higher accuracy, and improved quality of vectorized HD maps.

Conclusion: By leveraging foundation models and auxiliary tasks, MapFM enhances the generation of HD maps, which is beneficial for autonomous driving systems.
...
TL;DR: The NTIRE 2025 Shadow Removal Challenge had 306 participants, 17 teams submitted solutions, and evaluated on WSRD+ dataset with two tracks: reconstruction fidelity and visual perception via user study.


<details>
  <summary>Details</summary>
Motivation: To advance shadow removal techniques by evaluating them on diverse datasets and through user studies.

Method: Two evaluation tracks: reconstruction fidelity and visual perception via user study on WSRD+ dataset.

Result: 17 teams successfully submitted solutions, indicating active participation and interest in the challenge.

Conclusion: The challenge successfully engaged participants and highlighted the importance of both technical and perceptual evaluation metrics in shadow removal.
...
TL;DR: This paper introduces Show-o2, an improved native unified multimodal model that uses autoregressive modeling and flow matching, built upon a 3D causal variational autoencoder space, with a dual-path for spatial(-temporal) fusion, enabling scalability across image and video modalities and effective multimodal understanding and generation.


<details>
  <summary>Details</summary>
Motivation: To develop a versatile and scalable multimodal model that can handle various tasks across different modalities like text, images, and videos.

Method: Show-o2 uses a 3D causal variational autoencoder space, a dual-path for spatial(-temporal) fusion, autoregressive modeling for the language head, and flow matching for the flow head, along with a two-stage training recipe.

Result: Show-o2 models are versatile and can handle a wide range of multimodal tasks across diverse modalities including text, images, and videos.

Conclusion: Show-o2 is an effective and scalable multimodal model that enables efficient understanding and generation across different modalities.
...
TL;DR: The paper introduces CAN, a causality-aware navigation framework for Embodied AI, which improves task performance by considering causal relationships in sequential data.


<details>
  <summary>Details</summary>
Motivation: Existing visual navigation methods process all historical observations at once, missing internal data associations, which limits their performance.

Method: Examining navigation tasks through causality, introducing a causal framework, and proposing CAN with a Causal Understanding Module.

Result: Empirical evaluations show CAN outperforms baselines in various tasks and environments, with ablation studies confirming the effectiveness of the Causal Understanding Module.

Conclusion: CAN enhances environmental understanding by leveraging causality, offering improvements in both RL and SL without extra computational cost.
...
TL;DR: This paper introduces an LLM-based Planning Agent (LPA) to automate tasks in Failure Analysis labs, enhancing efficiency and integration with FA processes.


<details>
  <summary>Details</summary>
Motivation: The motivation is to automate intricate FA tasks using AI, improving efficiency and integration as the number of AI models grows.

Method: The method involves designing and implementing an LLM-based Planning Agent that combines LLMs with planning capabilities and external tools for autonomous processing and data retrieval.

Result: The evaluation results show the agent's operational effectiveness and reliability in supporting FA tasks.

Conclusion: The conclusion is that the LPA effectively enhances FA processes by automating tasks and integrating with existing systems.
...
TL;DR: This paper presents a method to generate reversible sentence embeddings without altering model weights, using a special memory token that enables exact reconstruction of text.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the capability of LLMs to reconstruct original text from embeddings, which could have applications in memory-based retrieval, compression, and controlled text generation.

Method: The method involves introducing a special memory token whose embedding is optimized through training on a fixed sequence, allowing the model to reconstruct the sequence when prompted with the embedding.

Result: The results show that Llama 3.1 8B can successfully reconstruct all tested sequences, and the approach works across English and Spanish datasets with sequences up to 240 tokens.

Conclusion: The findings demonstrate an interesting capability of LLMs and suggest potential applications in memory-based retrieval, compression, and controlled text generation.
...
TL;DR: This paper explores how the way knowledge is encoded during training affects the ability to unlearn specific facts in large language models, finding that paraphrasing during training helps with unlearning and that removing single facts from text chunks is hard.


<details>
  <summary>Details</summary>
Motivation: As LLMs are used more in real-world applications, there's a need to unlearn certain knowledge for privacy, accuracy, and safety. Previous research assumed fixed training and models, but this work looks at how training choices impact unlearning.

Method: The paper empirically studies the effect of different knowledge encoding strategies during training on the effectiveness of unlearning factual information.

Result: The experiments show that using paraphrased descriptions during training improves unlearning performance, and that unlearning individual facts from text chunks is challenging.

Conclusion: The study concludes that the way knowledge is encoded during training is crucial for enabling reliable post-hoc unlearning in LLMs.
...
TL;DR: Thunder-Tok is a new Korean tokenizer that reduces token fertility by 10% without harming model performance, using rule-based pre-tokenization and branching entropy-based selection.
...
Method: Thunder-Tok uses rule-based pre-tokenization aligned with Korean linguistics, a seed vocabulary of linguistic-like tokens, and a branching entropy-based selection algorithm to increase average token length and lower fertility.

Result: Thunder-Tok reduces token fertility by ~10%, leading to a 10% improvement in inference speed, without compromising performance on downstream tasks.
...
TL;DR: The paper evaluates how well current language technologies understand Basque and Spanish, finding that performance drops with linguistic variation, especially in Basque, and encoder-only models have trouble with Western Basque.


<details>
  <summary>Details</summary>
Motivation: To assess the ability of existing language technologies to handle Basque and Spanish language varieties, particularly focusing on how they perform with linguistic variation.

Method: Used Natural Language Inference (NLI) as a task, created a new manually-curated parallel dataset in Basque and Spanish with their variants, and conducted experiments with encoder-only and decoder-based LLMs.

Result: Performance decreased when dealing with linguistic variation, especially in Basque. Encoder-only models struggled more with Western Basque, which is more distant from the standard according to linguistic theory.

Conclusion: The study highlights challenges in understanding language variations, suggesting that models need better adaptation for dialects, particularly peripheral ones like Western Basque.
...
TL;DR: TopClustRAG is a RAG system using hybrid retrieval and K-Means clustering to improve answer quality.


<details>
  <summary>Details</summary>
Motivation: To enhance answer diversity, relevance, and faithfulness in large-scale RAG systems for question answering over web corpora.

Method: Hybrid retrieval combining sparse and dense indices, K-Means clustering to group passages, and cluster-specific prompts for LLMs.
...
TL;DR: This paper presents Thunder-DeID, a framework for de-identifying court judgments in South Korea, addressing scalability and legal compliance issues with a new dataset, PII categorization, and DNN pipeline.


<details>
  <summary>Details</summary>
Motivation: The South Korean judiciary needs to balance open access to justice with personal data protection, but current de-identification processes are insufficient for scale and legal requirements.

Method: The paper introduces Thunder-DeID, which includes a Korean legal dataset with annotated judgments, a systematic PII categorization, and a DNN-based de-identification pipeline.

Result: The model shows state-of-the-art performance in de-identifying court judgments.

Conclusion: Thunder-DeID aligns with legal standards and offers an effective solution for scalable and compliant de-identification of court judgments.
...
TL;DR: This paper surveys the use of LLMs in clinical trial recruitment, focusing on trial-patient matching, challenges in adoption, and future directions.


<details>
  <summary>Details</summary>
Motivation: Despite LLMs' success in general NLP tasks, their use in critical domains like clinical trial recruitment is limited. Trials and patient data are in natural language, requiring knowledge aggregation and reasoning, which LLMs can provide.

Method: The paper conducts a survey analyzing trial-patient matching tasks and contextualizing LLM-based approaches in clinical recruitment.

Result: The survey identifies challenges in adopting LLMs for clinical research and highlights existing benchmarks, approaches, and evaluation frameworks.

Conclusion: LLMs have potential for general solutions in clinical trial recruitment, but further work is needed on evaluation benchmarks and addressing domain-specific challenges.
...
TL;DR: This paper introduces a supervised contrastive learning method to improve language identification for low-resource languages by learning domain-invariant representations, achieving a 3.2% performance boost on out-of-domain data.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the poor performance of low-resource languages in language identification tasks due to class imbalance and data bias, particularly when they are limited to single-domain data like the Bible.

Method: The method involves a novel supervised contrastive learning (SCL) approach designed to learn domain-invariant representations for low-resource languages, aiming to reduce the impact of domain-specific biases in the training data.

Result: The approach improves LID performance on out-of-domain data for low-resource languages by 3.2%, showing its effectiveness in enhancing LID models.

Conclusion: The conclusion is that the proposed SCL method effectively addresses class imbalance and bias issues in low-resource languages, leading to better LID performance and suggesting potential for broader application in multilingual model training.
...
TL;DR: The paper introduces GIFI, a new metric for evaluating gender inclusivity in LLMs, and finds significant variations in inclusivity among 22 models.


<details>
  <summary>Details</summary>
Motivation: Previous studies on gender fairness in LLMs have focused mainly on binary gender distinctions, but there is a need for a more comprehensive metric that includes non-binary genders.

Method: The paper introduces GIFI, which evaluates LLMs at multiple levels, from probing with gender pronouns to testing generation and cognitive behaviors under different gender assumptions.

Result: The evaluation of 22 LLMs using GIFI reveals significant variations in their gender inclusivity.

Conclusion: The study emphasizes the importance of improving LLMs' gender inclusivity and provides a benchmark for future research.
...
TL;DR: The paper explores cross-cultural differences in interpreting intensifiers like 'quite' and 'very' in British and American English, finding that these differences come from both literal meanings and utterance cost weights, not just semantics or politeness.


<details>
  <summary>Details</summary>
Motivation: To understand why cross-cultural communication misunderstandings happen, specifically whether they are due to word meanings or pragmatic factors like politeness and brevity.

Method: Three experiments comparing interpretations of intensifiers between British and American English speakers, along with a computational cognitive model that models listeners' recursive reasoning about speakers' balance of informativity, politeness, and utterance cost.

Result: Cross-cultural differences in intensifier interpretation result from a mix of different literal meanings and varying weights on utterance cost, not just semantic differences or politeness norms alone.

Conclusion: The study shows that cross-cultural interpretation differences arise from the combination of semantic and pragmatic factors, highlighting the need to consider both in understanding communication nuances.
...
TL;DR: Ordered CommonGen benchmark evaluates LLMs' ability to follow concept order in generative tasks, revealing limitations in ordered coverage and diversity.


<details>
  <summary>Details</summary>
Motivation: To assess and improve LLMs' compositional generalization and instruction-following capabilities, especially when concept order is specified.

Method: Proposed Ordered CommonGen, a benchmark measuring ordered coverage by checking if concepts are generated in the specified order.

Result: 36 LLMs showed low diversity and identical outputs when concept order changed, with top LLM achieving ~75% ordered coverage.

Conclusion: Current LLMs need improvements in instruction-following and compositional generalization, suggesting future research directions.
...
TL;DR: The study uses character n-grams and ML models to attribute authorship in Romanian texts, with ANN performing best, achieving perfect results in some cases.


<details>
  <summary>Details</summary>
Motivation: To address authorship attribution for Romanian texts using a standard corpus, exploring if simple methods can match complex ones.

Method: Systematic evaluation of six ML techniques (SVM, LR, k-NN, DT, RF, ANN) with character n-gram features.

Result: ANN achieved highest performance, with perfect classification in four of fifteen runs using 5-grams.

Conclusion: Lightweight, interpretable n-gram approaches can achieve state-of-the-art accuracy for Romanian authorship attribution, showing potential in resource-constrained languages.
...
TL;DR: CC-Learn improves LLM reasoning consistency through reinforcement learning on cohorts of questions.


<details>
  <summary>Details</summary>
Motivation: Large language models struggle with consistent and robust reasoning, so there's a need for methods to enhance their reliability in reasoning tasks.

Method: CC-Learn is a reinforcement learning framework that trains on cohorts of similar questions using programmatic abstractions, with a composite objective including cohort accuracy, retrieval bonus, and rejection penalty.
...
TL;DR: This paper explores privacy risks in the internal reasoning processes of large models used as personal agents, showing that increased reasoning steps can lead to more sensitive data leakage, highlighting the need for safety measures beyond just outputs.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address privacy concerns in reasoning models, as their internal traces might expose sensitive data even if outputs are secure.

Method: Through probing and agentic evaluations, the study investigates how test-time compute approaches and increased reasoning steps affect privacy leakage.

Result: The results show that more reasoning steps lead to more verbose reasoning and higher privacy leakage, despite increased caution in final answers.

Conclusion: The conclusion is that privacy protection must include the model's internal reasoning, not just outputs, to mitigate risks as reasoning enhances utility but expands attack surfaces.
...
TL;DR: PhantomHunter is a new LLM-generated text detector that effectively identifies text from privately-tuned models, achieving high F1 scores.


<details>
  <summary>Details</summary>
Motivation: The rise of large language models has led to issues like misinformation and academic misconduct, and existing detectors struggle with text from privately-tuned models.

Method: PhantomHunter uses a family-aware learning framework to capture shared traits among base models and their derivatives, avoiding reliance on individual characteristics.

Result: Experiments showed PhantomHunter outperformed 7 baselines and 3 industrial services, achieving F1 scores over 96% on LLaMA, Gemma, and Mistral families.

Conclusion: PhantomHunter addresses the challenge of detecting LLM-generated text from privately-tuned models, offering a robust solution for real-world applications.
...
### [131] [Identifiability by common backdoor in summary causal graphs of time series](https://arxiv.org/abs/2506.14862)
...
### [132] [Probabilistic closed-form formulas for pricing nonlinear payoff variance and volatility derivatives under Schwartz model with time-varying log-return volatility](https://arxiv.org/abs/2506.15386)
...
### [133] [Density estimation via periodic scaled Korobov kernel method with exponential decay condition](https://arxiv.org/abs/2506.15419)
...
### [134] [An accurate and revised version of optical character recognition-based speech synthesis using LabVIEW](https://arxiv.org/abs/2506.15029)
...
<details>
  <summary>Details</summary>
Motivation: To address the limitations of Braille books and NGO audio recordings, which restrict access to books for blind individuals.

Method: Developing an accurate, reliable, cost-effective, and user-friendly OCR-based speech synthesis system using LabVIEW.

Result: The system provides an effective way for visually impaired people to access books, leveraging speech over text for better communication.

Conclusion: The OCR-based speech synthesis system using LabVIEW is a promising solution to enhance book accessibility for the blind.
...
### [135] [SonicVerse: Multi-Task Learning for Music Feature-Informed Captioning](https://arxiv.org/abs/2506.15154)
...
### [137] [MODS: Multi-source Observations Conditional Diffusion Model for Meteorological State Downscaling](https://arxiv.org/abs/2506.14798)
...
### [138] [Advancing Loss Functions in Recommender Systems: A Comparative Study with a Rényi Divergence-Based Solution](https://arxiv.org/abs/2506.15120)
...
TL;DR: This paper presents a new approach for full-body human pose estimation using sparse, loosely attached IMU sensors, leveraging transformer-based diffusion models and garment-related parameters to improve accuracy.


<details>
  <summary>Details</summary>
Motivation: Existing motion capture methods rely on tightly attached IMU sensors, which is not always feasible in real-world applications. The paper aims to address this limitation by developing a method that works with loosely attached sensors.

Method: The authors simulate IMU recordings from a garment-aware motion dataset and use transformer-based diffusion models to synthesize loose IMU data and estimate human poses. They also incorporate garment-related parameters during training.

Result: The proposed diffusion models trained on simulated data outperformed existing methods in both quantitative and qualitative experiments, demonstrating effectiveness in handling loose IMU data.

Conclusion: The study shows that using diffusion models with garment parameters can effectively estimate human poses from loosely attached IMUs, suggesting a promising direction for future research in motion capture.
...
### [142] [Explain First, Trust Later: LLM-Augmented Explanations for Graph-Based Crypto Anomaly Detection](https://arxiv.org/abs/2506.14933)
*Adriana Watson*

Main category: cs.CE

TL;DR: The paper discusses the need for automated detection tools in DeFi to combat financial crime due to the challenges posed by the novel technology.


<details>
  <summary>Details</summary>
Motivation: The motivation is the rapid growth of the DeFi community and the rise in financial crime, which is difficult to address with existing methods due to the novelty of cryptocurrency technology.

Method: The method involves developing automated detection tools aligned with policies to tackle cryptocurrency-related criminality.

Result: The result is the implementation of automated detection tools that help in identifying and addressing financial crimes in DeFi.

Conclusion: The conclusion emphasizes the importance of automated tools in the DeFi space for effective crime detection and prosecution, given the challenges of new technology.
...
### [143] [Deploying and Evaluating Multiple Deep Learning Models on Edge Devices for Diabetic Retinopathy Detection](https://arxiv.org/abs/2506.14834)
...
### [144] [Foundation Artificial Intelligence Models for Health Recognition Using Face Photographs (FAHR-Face)](https://arxiv.org/abs/2506.14909)
...
### [145] [Empirical Studies of Large Scale Environment Scanning by Consumer Electronics](https://arxiv.org/abs/2506.14771)
...
### [146] [Improving Prostate Gland Segmenting Using Transformer based Architectures](https://arxiv.org/abs/2506.14844)
*Shatha Abudalou*
...
### [147] [Recursive Variational Autoencoders for 3D Blood Vessel Generative Modeling](https://arxiv.org/abs/2506.14914)
...
### [148] [NeuroMoE: A Transformer-Based Mixture-of-Experts Framework for Multi-Modal Neurological Disorder Classification](https://arxiv.org/abs/2506.14970)
...
### [150] [Privacy-Preserving Chest X-ray Classification in Latent Space with Homomorphically Encrypted Neural Inference](https://arxiv.org/abs/2506.15258)
...
### [151] [FedWSIDD: Federated Whole Slide Image Classification via Dataset Distillation](https://arxiv.org/abs/2506.15365)
...
### [152] [A Real-time Endoscopic Image Denoising System](https://arxiv.org/abs/2506.15395)
...
### [153] [Advanced cervical cancer classification: enhancing pap smear images with hybrid PMD Filter-CLAHE](https://arxiv.org/abs/2506.15489)
...
### [154] [Automated MRI Tumor Segmentation using hybrid U-Net with Transformer and Efficient Attention](https://arxiv.org/abs/2506.15562)
...
### [155] [Multivariate and Multiple Contrast Testing in General Covariate-adjusted Factorial Designs](https://arxiv.org/abs/2506.15292)
*Marléne Baumeister,Konstantin Emil Thiel,Lynn Matits,Georg Zimmermann,Markus Pauly,Paavo Sattler*

Main category: stat.ME

TL;DR: The paper proposes an extension of multiple contrast testing procedures (MCTPs) within a semiparametric MANCOVA framework to evaluate intervention effects on multiple outcomes, accounting for confounding and applicable beyond traditional assumptions like multivariate normality.


<details>
  <summary>Details</summary>
Motivation: Researchers need to evaluate intervention effects on multiple, potentially correlated outcomes, comparing interventions with each other and a control, while accounting for confounding factors. Traditional MCTPs may not be suitable under non-normal or heteroscedastic data.

Method: Extension of MCTPs in a semiparametric MANCOVA framework, allowing for flexibility beyond multivariate normality, homoscedasticity, and non-singular covariance structures.

Result: The approach is illustrated with multivariate psychological intervention data, focusing on joint physiological and psychological constructs like heart rate variability.

Conclusion: The proposed method provides a more flexible and robust multiple contrast testing procedure for evaluating interventions across multiple outcomes with confounding factors.
...
### [156] [Causal inference amid missingness-specific independencies and mechanism shifts](https://arxiv.org/abs/2506.15441)
...
### [157] [BMFM-RNA: An Open Framework for Building and Evaluating Transcriptomic Foundation Models](https://arxiv.org/abs/2506.14861)
...
### [158] [Advanced Prediction of Hypersonic Missile Trajectories with CNN-LSTM-GRU Architectures](https://arxiv.org/abs/2506.15043)
...
### [159] [RAS-Eval: A Comprehensive Benchmark for Security Evaluation of LLM Agents in Real-World Environments](https://arxiv.org/abs/2506.15253)
...
### [160] [Evaluation Pipeline for systematically searching for Anomaly Detection Systems](https://arxiv.org/abs/2506.15388)
*Florian Rokohl,Alexander Lehnert,Marc Reichenbach*

Main category: cs.CR

TL;DR: The paper discusses using FPGAs for real-time anomaly detection in medical digitalization to enhance security.
...
Result: The system achieves real-time performance and meets power constraints, with overall performance validated through a holistic evaluation.

Conclusion: Using FPGAs for anomaly detection in medical networks is effective for addressing security challenges while adhering to real-time and power limitations.
...
### [161] [An Empirical Study of Bugs in Data Visualization Libraries](https://arxiv.org/abs/2506.15084)
...
### [162] [Uncovering Intention through LLM-Driven Code Snippet Description Generation](https://arxiv.org/abs/2506.15453)
...
### [163] [On the Upper Bounds for the Matrix Spectral Norm](https://arxiv.org/abs/2506.15660)
*Alexey Naumov,Maxim Rakhuba,Denis Ryapolov,Sergey Samsonov*

Main category: math.NA

TL;DR: The paper introduces a Counterbalance estimator for tighter upper bounds on matrix spectral norms using matrix-vector products, outperforming the power method in synthetic and real-world scenarios, particularly for matrices with fast-decaying spectra.


<details>
  <summary>Details</summary>
Motivation: The motivation is to estimate the spectral norm of a matrix more accurately using matrix-vector products, which is crucial for applications like deep learning and inverse problems where traditional methods like the power method may not provide tight enough bounds.

Method: The method involves a new Counterbalance estimator that leverages matrix-vector products to derive upper bounds on the spectral norm with probabilistic guarantees against underestimation.

Result: The Counterbalance estimator provides significantly tighter upper bounds compared to standard methods like the power method in both synthetic and real-world settings, especially for matrices with fast-decaying spectra.

Conclusion: The conclusion is that the proposed Counterbalance estimator is effective for spectral norm estimation, offering better performance than existing methods in scenarios relevant to deep learning and inverse problems.
...
### [164] [Intrinsic and Extrinsic Organized Attention: Softmax Invariance and Network Sparsity](https://arxiv.org/abs/2506.15541)
...
### [166] [Collaborative Interest-aware Graph Learning for Group Identification](https://arxiv.org/abs/2506.14826)
...
### [167] [Detecting Narrative Shifts through Persistent Structures: A Topological Analysis of Media Discourse](https://arxiv.org/abs/2506.14836)
...
### [168] [PFMBench: Protein Foundation Model Benchmark](https://arxiv.org/abs/2506.14796)
...
### [169] [Preparing for the Intelligence Explosion](https://arxiv.org/abs/2506.14863)
*William MacAskill,Fin Moorhouse*

Main category: cs.CY

TL;DR: The paper discusses the potential of AI to accelerate technological progress, leading to rapid development of grand challenges that require immediate attention, not just future AI alignment.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the rapid and consequential developments brought by AI, which may include both significant opportunities and risks that need proactive management today.

Method: The paper presents a conceptual analysis of AI's impact on future technological and political developments, identifying key grand challenges and their implications.

Result: The result is the identification of various grand challenges posed by AI advancements, highlighting the need for current AGI preparedness beyond just alignment.

Conclusion: The conclusion emphasizes that AGI preparedness must include proactive strategies for managing the fast-occurring developments from an intelligence explosion, not just focusing on future alignment of AI systems.
...
### [170] [Hypothesis Testing for Quantifying LLM-Human Misalignment in Multiple Choice Settings](https://arxiv.org/abs/2506.14997)
*Harbin Hong,Sebastian Caldas,Liu Leqi*

Main category: cs.CY

TL;DR: This paper introduces a framework using hypothesis testing to evaluate how well LLMs mimic human behavior in multiple-choice surveys, finding that a popular model fails to accurately represent diverse sub-populations on contentious topics.


<details>
  <summary>Details</summary>
Motivation: As LLMs are increasingly used in social science research, it's important to check if they can accurately replicate human behaviors, especially in surveys with multiple-choice answers.

Method: The researchers used hypothesis testing to create a quantitative framework that compares LLM-simulated behaviors with real human behaviors in multiple-choice survey scenarios.

Result: The applied framework revealed that a widely used language model is not effective at simulating the opinions of different demographic groups (like various races, ages, and income levels) when dealing with controversial questions.

Conclusion: The study suggests that using LLMs in social science research needs more careful approaches than just simulating human subjects, as they may not align well with certain populations, especially on contentious issues.
...
### [171] [Transit for All: Mapping Equitable Bike2Subway Connection using Region Representation Learning](https://arxiv.org/abs/2506.15113)
...
### [172] [Forecasting the spatiotemporal evolution of fluid-induced microearthquakes with deep learning](https://arxiv.org/abs/2506.14923)
...
### [173] [Improved Image Reconstruction and Diffusion Parameter Estimation Using a Temporal Convolutional Network Model of Gradient Trajectory Errors](https://arxiv.org/abs/2506.14995)
*Jonathan B. Martin,Hannah E. Alderson,John C. Gore,Mark D. Does,Kevin D. Harkins*

Main category: physics.med-ph

TL;DR: This paper presents a nonlinear gradient system model using temporal convolutional networks to predict and correct gradient distortions in magnetic resonance imaging, improving image quality and diffusion parameter mapping.


<details>
  <summary>Details</summary>
Motivation: Errors in gradient trajectories cause artifacts in MRI, especially in non-Cartesian sequences. Current methods may not sufficiently address nonlinear distortions.

Method: Training gradient waveforms were measured on a small animal imaging system and used to train a temporal convolutional network to predict gradient waveforms.

Result: The network accurately predicted nonlinear distortions and improved image quality and diffusion parameter mapping when integrated into the reconstruction pipeline.

Conclusion: Temporal convolutional networks offer better modeling of gradient system behavior than linear methods, enabling retrospective correction of gradient errors.
...
### [174] [Feedback-MPPI: Fast Sampling-Based MPC via Rollout Differentiation -- Adios low-level controllers](https://arxiv.org/abs/2506.14855)
*Tommaso Belvedere,Michael Ziegltrum,Giulio Turrisi,Valerio Modugno*

Main category: cs.RO

TL;DR: This paper introduces Feedback-MPPI (F-MPPI), a novel framework that enhances standard MPPI by incorporating local linear feedback gains, allowing for rapid closed-loop corrections without full re-optimization at each timestep. The results show improved control performance and stability, enabling robust, high-frequency operation in complex robotic systems.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the computational limitations of Model Predictive Path Integral (MPPI) control in real-time, high-frequency robotic control scenarios, while maintaining its flexibility in handling nonlinear dynamics and non-convex costs.

Method: The method involves augmenting standard MPPI with local linear feedback gains derived from sensitivity analysis, inspired by Riccati-based feedback in gradient-based MPC. These gains enable rapid closed-loop corrections around the current state without requiring full re-optimization at each timestep.

Result: The results demonstrate that incorporating local feedback significantly improves control performance and stability, allowing for robust, high-frequency operation suitable for complex robotic systems, as shown through simulations and real-world experiments on a quadrupedal robot and a quadrotor.

Conclusion: The conclusion is that F-MPPI is effective in enhancing MPPI's applicability for real-time, high-frequency robotic control by enabling rapid corrections and improving stability, making it suitable for complex tasks like dynamic locomotion and aggressive maneuvers.
...
TL;DR: This paper explores using drones with machine learning and computer vision to help visually impaired people navigate urban areas, presenting a path planning system integrated with GPS for global planning and a multi-DNN framework for obstacle avoidance, validated in three scenarios.


<details>
  <summary>Details</summary>
Motivation: To develop a system that assists visually impaired people (VIPs) in navigating outdoor urban environments using autonomous drones equipped with onboard sensors, machine learning, and computer vision algorithms.

Method: The paper presents a perception-based local path planning system integrated with a global planner using GPS and maps. It employs a multi-DNN framework for obstacle avoidance for both the UAV and the VIP.

Result: The algorithms were evaluated on a drone-human system in a university campus environment, demonstrating feasibility in three scenarios: walking on a footpath, near parked vehicles, and in a crowded street.

Conclusion: The study concludes that the proposed system is feasible for assisting VIPs in urban navigation through integrated path planning and obstacle avoidance using drones, machine learning, and computer vision.
...
### [180] [Comparative Analysis of QNN Architectures for Wind Power Prediction: Feature Maps and Ansatz Configurations](https://arxiv.org/abs/2506.14795)
...
### [181] [Data Verbalisation: What is Text Doing in a Data Visualisation?](https://arxiv.org/abs/2506.15129)
*Paul Murrell*
...
### [182] [See What I Mean? CUE: A Cognitive Model of Understanding Explanations](https://arxiv.org/abs/2506.14775)
...
### [183] [WebXAII: an open-source web framework to study human-XAI interaction](https://arxiv.org/abs/2506.14777)
...
### [184] [Analyzing Character Representation in Media Content using Multimodal Foundation Model: Effectiveness and Trust](https://arxiv.org/abs/2506.14799)
...
### [185] [The Hardness of Achieving Impact in AI for Social Impact Research: A Ground-Level View of Challenges & Opportunities](https://arxiv.org/abs/2506.14829)
...
### [186] [Insights Informed Generative AI for Design: Incorporating Real-world Data for Text-to-Image Output](https://arxiv.org/abs/2506.15008)
...
### [187] [Mapping Caregiver Needs to AI Chatbot Design: Strengths and Gaps in Mental Health Support for Alzheimer's and Dementia Caregivers](https://arxiv.org/abs/2506.15047)
...
### [188] [Accessible Gesture-Driven Augmented Reality Interaction System](https://arxiv.org/abs/2506.15189)
*Yikan Wang*

Main category: cs.HC

TL;DR: This paper introduces a gesture-based AR system using deep learning for motor-impaired users, improving efficiency and satisfaction.


<details>
  <summary>Details</summary>
Motivation: AR is inaccessible for users with motor impairments due to precise input methods. The study aims to make AR more accessible and adaptable.

Method: The system uses vision transformers, temporal convolutional networks, and graph attention networks for gesture recognition, along with federated learning and reinforcement learning for privacy and optimization.

Result: Experiments show 20% better task completion and 25% higher user satisfaction for motor-impaired users compared to baseline AR systems.

Conclusion: The approach enhances AR accessibility and scalability through adaptive gesture-based interaction.
...
### [189] [Co-Creative Learning via Metropolis-Hastings Interaction between Humans and AI](https://arxiv.org/abs/2506.15468)
...
### [190] [Optimizing Web-Based AI Query Retrieval with GPT Integration in LangChain A CoT-Enhanced Prompt Engineering Approach](https://arxiv.org/abs/2506.15512)
*Wenqi Guan,Yang Fang*

Main category: cs.HC

TL;DR: This paper proposes integrating GPT-based models into LangChain to improve remote learning resource retrieval with CoT reasoning and prompt engineering, showing better user satisfaction and learning outcomes.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the lack of depth in contextual meaning in current remote learning resource retrieval systems, aiming to provide more comprehensive and contextually relevant information for complex student queries.

Method: The method involves integrating GPT-based models within the LangChain framework, utilizing CoT reasoning and prompt engineering to create a more intuitive and productive system for retrieving learning resources.

Result: The results demonstrate improvements in user satisfaction and learning outcomes when using the proposed framework compared to paradigmatic LLMs.

Conclusion: The conclusion is that integrating GPT models with LangChain using CoT and prompt engineering effectively enhances retrieval precision and relevance, better meeting students' needs.
...
### [191] [Omnidirectional Video Super-Resolution using Deep Learning](https://arxiv.org/abs/2506.14803)
...
### [193] [DEFORMER: Coupling Deformed Localized Patterns with Global Context for Robust End-to-end Speech Recognition](https://arxiv.org/abs/2207.01732)
...
### [194] [Dynamic ASR Pathways: An Adaptive Masking Approach Towards Efficient Pruning of A Multilingual ASR Model](https://arxiv.org/abs/2309.13018)
*Jiamin Xie,Ke Li,Jinxi Guo,Andros Tjandra,Yuan Shangguan,Leda Sari,Chunyang Wu,Junteng Jia,Jay Mahadeokar,Ozlem Kalinli*

Main category: eess.AS

TL;DR: This paper introduces an adaptive masking approach for efficiently pruning multilingual ASR models, creating either sparse monolingual models or a sparse multilingual model called Dynamic ASR Pathways, which dynamically adapts sub-networks and reduces the need for language-specific pruning.


<details>
  <summary>Details</summary>
Motivation: The motivation is to compress multilingual ASR models efficiently without significant performance loss, addressing the inefficiency of existing methods that require multiple pruning and re-training rounds per language.

Method: The method involves using adaptive masking in two scenarios: one for creating sparse monolingual models and another for developing a sparse multilingual model (Dynamic ASR Pathways) that dynamically adapts sub-networks from different initializations.

Result: The approach outperforms existing pruning methods for sparse monolingual models and demonstrates that Dynamic ASR Pathways can jointly discover and train better sub-networks (pathways) in a single multilingual model by adapting from various sub-network initializations.

Conclusion: The conclusion is that the adaptive masking approach enables efficient pruning of multilingual ASR models, reducing the necessity for language-specific pruning steps and improving overall model compression effectiveness.
...
### [195] [MixRep: Hidden Representation Mixup for Low-Resource Speech Recognition](https://arxiv.org/abs/2310.18450)
*Jiamin Xie,John H. L. Hansen*
...
### [196] [Thinking in Directivity: Speech Large Language Model for Multi-Talker Directional Speech Recognition](https://arxiv.org/abs/2506.14973)
...
TL;DR: This paper introduces directional-SpeechLlama, a method for smart glasses that improves speech recognition and source localization using microphone arrays, along with two techniques called S-DOT and CDDA.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore how Speech LLMs can handle multi-channel audio with spatial cues, which is currently under-researched.

Method: The method involves directional-SpeechLlama, which uses smart glasses' microphone arrays. It includes S-DOT for training and CDDA for data augmentation to enhance directivity understanding.

Result: The results show that directional-SpeechLlama effectively links textual and spatial audio, performing well in speech recognition and source localization.

Conclusion: The conclusion is that directional-SpeechLlama successfully captures the relationship between text and spatial audio, improving performance in the mentioned tasks.
...
TL;DR: HAC is a unified neural speech codec that factorizes its bottleneck into three linguistic levels: acoustic, phonetic, and lexical. It uses knowledge distillation from pre-trained models for better disentanglement and reconstruction.


<details>
  <summary>Details</summary>
Motivation: The motivation is to create a unified speech codec that can separate different linguistic levels within a single model, improving disentanglement and preserving naturalness.

Method: HAC uses two knowledge distillation objectives: one from HuBERT for phoneme-level structure and another from LaBSE for lexical cues, factorizing the bottleneck into acoustic, phonetic, and lexical levels.

Result: HAC's factorized bottleneck produces disentangled token sets that align with phonemes and capture word-level semantics, outperforming single-level baselines in disentanglement and reconstruction quality.

Conclusion: HAC shows potential as a unified discrete speech representation, bridging acoustic detail and lexical meaning for better speech generation and understanding tasks.
...
### [198] [On the Effectiveness of Classical Regression Methods for Optimal Switching Problems](https://arxiv.org/abs/2506.15436)
*Martin Andersson,Benny Avelin,Marcus Olofsson*

Main category: math.OC

TL;DR: Simple regression methods like k-NN and PCA are effective for optimal switching problems in high dimensions, outperforming complex models due to their robustness against approximation bias and Monte Carlo noise.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the effectiveness of simple regression methods in solving optimal switching problems, which are computationally demanding and typically require solving intractable PDE systems.

Method: The study tests eight regression approaches on four benchmark problems, analyzing their performance under various conditions. It also establishes concentration bounds for k-NN regression under jump-diffusion dynamics and investigates the role of PCA in enabling k-NN to scale to high dimensions.

Result: Simple regression methods maintain stable performance across diverse problem characteristics, even after extensive neural network optimization. Contaminated training targets favor robust approaches over complex alternatives like neural networks.

Conclusion: Practitioners should use simple, minimally-tuned regression methods for optimal switching problems as they provide reliable performance despite computational challenges.
...
### [199] [Scaling Intelligence: Designing Data Centers for Next-Gen Language Models](https://arxiv.org/abs/2506.15006)
...
### [200] [J3DAI: A tiny DNN-Based Edge AI Accelerator for 3D-Stacked CMOS Image Sensor](https://arxiv.org/abs/2506.15316)
...
### [201] [MedSyn: Enhancing Diagnostics with Human-AI Collaboration](https://arxiv.org/abs/2506.14774)
*Burcu Sayin,Ipek Baris Schlicht,Ngoc Vo Hong,Sara Allievi,Jacopo Staiano,Pasquale Minervini,Andrea Passerini*

Main category: cs.LG

TL;DR: This paper introduces MedSyn, a hybrid human-AI framework for clinical decision-making through multi-step dialogues between physicians and LLMs, showing open-source LLMs' potential as physician assistants.


<details>
  <summary>Details</summary>
Motivation: Clinical decision-making is complex and prone to cognitive biases, incomplete information, and ambiguity. Traditional one-shot or limited-interaction LLMs may not capture real-world medical complexities, motivating the need for a more interactive framework.

Method: The paper proposes MedSyn, a hybrid human-AI framework enabling multi-step, interactive dialogues between physicians and LLMs to refine diagnoses and treatment decisions. It involves simulated physician-LLM interactions to assess open-source LLMs' potential as physician assistants.

Result: Results indicate that open-source LLMs are promising as physician assistants in real-world scenarios, suggesting their potential to improve diagnostic accuracy and patient outcomes through interactive frameworks like MedSyn.

Conclusion: MedSyn offers a dynamic approach to clinical decision-making by facilitating interactive dialogues between physicians and LLMs. Future work involves real physician interactions to validate its effectiveness in enhancing diagnostic accuracy and patient outcomes.
...
### [202] [PIPE: Physics-Informed Position Encoding for Alignment of Satellite Images and Time Series](https://arxiv.org/abs/2506.14786)
...
### [203] [Topology-Aware and Highly Generalizable Deep Reinforcement Learning for Efficient Retrieval in Multi-Deep Storage Systems](https://arxiv.org/abs/2506.14787)
...
### [204] [Assembly of Experts: Linear-time construction of the Chimera LLM variants with emergent and adaptable behaviors](https://arxiv.org/abs/2506.14794)
...
### [205] [Bound by semanticity: universal laws governing the generalization-identification tradeoff](https://arxiv.org/abs/2506.14797)
...
### [206] [ss-Mamba: Semantic-Spline Selective State-Space Model](https://arxiv.org/abs/2506.14802)
*Zuochen Ye*
...
### [207] [Training with Confidence: Catching Silent Errors in Deep Learning Training with Automated Proactive Checks](https://arxiv.org/abs/2506.14813)
*Yuxuan Jiang,Ziming Zhou,Boyu Xu,Beijie Liu,Runhui Xu,Peng Huang*

Main category: cs.LG

TL;DR: TRAINCHECK is a framework that detects silent training errors in deep learning models by inferring invariants and providing debugging help.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address silent training errors in deep learning models, which are difficult to detect and diagnose during the training process.

Method: The method involves automatically inferring invariants specific to DL training and using them to detect errors proactively during training.

Result: TRAINCHECK detected 18 out of 20 reproduced silent errors in one training iteration and found 6 unknown bugs in popular training libraries.

Conclusion: The conclusion is that TRAINCHECK effectively detects and helps debug silent training errors in deep learning, improving reliability and trustworthiness.
...
### [208] [Reinforcing VLMs to Use Tools for Detailed Visual Reasoning Under Resource Constraints](https://arxiv.org/abs/2506.14821)
*Sunil Kumar,Bowen Zhao,Leo Dirac,Paulina Varshavskaya*

Main category: cs.LG

TL;DR: The paper proposes using GRPO to train smaller VLMs with external tools for better visual reasoning.


<details>
  <summary>Details</summary>
Motivation: Vision-language models struggle with detailed visual reasoning under limited compute resources.

Method: Group Relative Policy Optimization (GRPO) with external tools like zoom, simple reward structure, simplified tool-calling interface, additional tokens for tool results, and training data focused on hard visual examples.

Result: Better performance on VQA tasks compared to baseline models.

Conclusion: Combining GRPO with specific training strategies improves visual reasoning in smaller VLMs.
...
### [209] [FedNano: Toward Lightweight Federated Tuning for Pretrained Multimodal Large Language Models](https://arxiv.org/abs/2506.14824)
...
### [210] [Optimization of bi-directional gated loop cell based on multi-head attention mechanism for SSD health state classification model](https://arxiv.org/abs/2506.14830)
...
### [211] [ETS: Open Vocabulary Electroencephalography-To-Text Decoding and Sentiment Classification](https://arxiv.org/abs/2506.14783)
*Mohamed Masry,Mohamed Amen,Mohamed Elzyat,Mohamed Hamed,Norhan Magdy,Maram Khaled*

Main category: cs.LG

TL;DR: This study introduces ETS, a framework combining EEG and eye-tracking data to improve decoding natural language from brain activity, especially for open-vocabulary scenarios, achieving better performance than previous methods.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenge of decoding natural language from EEG data in open-vocabulary scenarios, where traditional methods face difficulties due to noise and variability.

Method: The method involves developing a framework called ETS that integrates EEG with synchronized eye-tracking data to tackle open-vocabulary text generation and sentiment classification of perceived language.

Result: The model shows superior performance on BLEU and Rouge scores for EEG-To-Text decoding and up to 10% higher F1 score on EEG-based ternary sentiment classification compared to supervised baselines.

Conclusion: The study concludes that ETS can handle data from various subjects and sources, indicating significant potential for creating high-performance open-vocabulary EEG-to-text systems.
...
### [212] [Revisiting Reinforcement Learning for LLM Reasoning from A Cross-Domain Perspective](https://arxiv.org/abs/2506.14965)
...
### [213] [Determinação Automática de Limiar de Detecção de Ataques em Redes de Computadores Utilizando Autoencoders](https://arxiv.org/abs/2506.14937)
*Luan Gonçalves Miranda,Pedro Ivo da Cruz,Murilo Bellezoni Loiola*

Main category: cs.LG

TL;DR: The paper proposes using machine learning algorithms to automatically set the separation threshold in Anomaly Detection Systems based on Autoencoders, evaluating K-NN, K-Means, and SVM.


<details>
  <summary>Details</summary>
Motivation: Current digital security mechanisms, like Autoencoders-based Anomaly Detection Systems, face challenges due to data imbalance. The separation threshold used to classify reconstruction errors is non-trivial and non-standardized, affecting detection performance.

Method: The authors evaluated three machine learning algorithms—K-Nearest Neighbors (K-NN), K-Means, and Support Vector Machine (SVM)—to automatically determine the separation threshold for anomaly detection.

Result: The paper's results demonstrate that using machine learning algorithms can effectively automate the threshold definition, improving the detection process's performance.

Conclusion: The study concludes that automatically defining the separation threshold with ML algorithms enhances the effectiveness of Anomaly Detection Systems using Autoencoders, addressing data imbalance issues.
...
### [214] [Optimal Embedding Learning Rate in LLMs: The Effect of Vocabulary Size](https://arxiv.org/abs/2506.15025)
...
### [215] [Flat Channels to Infinity in Neural Loss Landscapes](https://arxiv.org/abs/2506.14951)
...
### [216] [Fair Algorithms with Probing for Multi-Agent Multi-Armed Bandits](https://arxiv.org/abs/2506.14988)
*Tianyi Xu,Jiaxin Liu,Zizhan Zheng*

Main category: cs.LG

TL;DR: The paper proposes a MA-MAB framework that ensures fairness and optimizes system performance through a probing strategy, achieving better results than baselines in experiments.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenge of decision-making with limited information about arm rewards in a multi-agent multi-armed bandit framework, ensuring fair outcomes while maximizing system performance.

Method: The method involves a novel probing framework that gathers information about selected arms before allocation. In the offline setting, a greedy algorithm using submodular properties is designed. For the online setting, an algorithm with sublinear regret and fairness is developed.

Result: Experiments on synthetic and real-world datasets show the approach outperforms baselines, achieving better fairness and efficiency.

Conclusion: The conclusion states that the proposed MA-MAB framework effectively balances fairness and system performance through strategic probing, with strong theoretical guarantees and empirical validation.
...
### [217] [When and How Unlabeled Data Provably Improve In-Context Learning](https://arxiv.org/abs/2506.15329)
...
### [218] [Capturing Polysemanticity with PRISM: A Multi-Concept Feature Description Framework](https://arxiv.org/abs/2506.15538)
...
### [219] [CACTUS as a Reliable Tool for Early Classification of Age-related Macular Degeneration](https://arxiv.org/abs/2506.14843)
...
### [220] [LoX: Low-Rank Extrapolation Robustifies LLM Safety Against Fine-tuning](https://arxiv.org/abs/2506.15606)
...
### [221] [AutoRule: Reasoning Chain-of-thought Extracted Rule-based Rewards Improve Preference Learning](https://arxiv.org/abs/2506.15651)
...
### [222] [Stable CDE Autoencoders with Acuity Regularization for Offline Reinforcement Learning in Sepsis Treatment](https://arxiv.org/abs/2506.15019)
*Yue Gao*
...
### [223] [SFT-GO: Supervised Fine-Tuning with Group Optimization for Large Language Models](https://arxiv.org/abs/2506.15021)
...
### [225] [Sequential Policy Gradient for Adaptive Hyperparameter Optimization](https://arxiv.org/abs/2506.15051)
...
### [226] [Singular Value Decomposition on Kronecker Adaptation for Large Language Model](https://arxiv.org/abs/2506.15251)
...
### [227] [Pixel-level Certified Explanations via Randomized Smoothing](https://arxiv.org/abs/2506.15499)
*Alaa Anani,Tobias Lorenz,Mario Fritz,Bernt Schiele*

Main category: cs.LG

TL;DR: This paper introduces a certification framework for pixel-level attribution methods using randomized smoothing, ensuring robustness against small input perturbations.


<details>
  <summary>Details</summary>
Motivation: Post-hoc attribution methods are non-robust to small input perturbations, which affects their reliability and trustworthiness in explaining deep learning predictions.

Method: The framework uses randomized smoothing to sparsify and smooth attribution maps, reformulating the task as a segmentation problem to certify each pixel's importance against $\\

Result: The certified attributions are robust, interpretable, and faithful, showing effectiveness across 12 attribution methods and 5 ImageNet models.

Conclusion: The proposed framework provides rigorous robustness guarantees for pixel-level attribution scores, enabling their reliable use in downstream tasks.
...
### [228] [Unlocking Post-hoc Dataset Inference with Synthetic Data](https://arxiv.org/abs/2506.15271)
...
### [229] [Active Learning-Guided Seq2Seq Variational Autoencoder for Multi-target Inhibitor Generation](https://arxiv.org/abs/2506.15309)
...
### [230] [Unifying VXAI: A Systematic Review and Framework for the Evaluation of Explainable AI](https://arxiv.org/abs/2506.15408)
...
### [231] [Reward Models in Deep Reinforcement Learning: A Survey](https://arxiv.org/abs/2506.15421)
...
### [232] [Zero-Shot Reinforcement Learning Under Partial Observability](https://arxiv.org/abs/2506.15446)
*Scott Jeen,Tom Bewley,Jonathan M. Cullen*

Main category: cs.LG

TL;DR: This paper studies how zero-shot RL performs under partial observability and finds that memory-based methods improve results compared to memory-free ones.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand the limitations of zero-shot RL in real-world scenarios where full observability isn't possible, and to find solutions like memory-based architectures.

Method: The method involves analyzing standard zero-shot RL methods under partial observability and testing memory-based approaches in domains with partial state, reward, and dynamics information.

Result: Results show that memory-based zero-shot RL methods outperform memory-free baselines in partially observable environments.

Conclusion: The conclusion is that memory-based architectures are effective for zero-shot RL in partial observability settings, suggesting their use in real-world applications.
...
### [233] [Warping and Matching Subsequences Between Time Series](https://arxiv.org/abs/2506.15452)
*Simiao Lin,Wannes Meert,Pieter Robberechts,Hendrik Blockeel*

Main category: cs.LG

TL;DR: The paper introduces a new technique to simplify and visualize warping paths in time series comparisons, focusing on key transformations like shift, compression, and amplitude differences to improve interpretability.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the gap in qualitative comparison of time series beyond elastic distance measures, which currently lack methods to show structural relationships and transformations between subsequences.

Method: The method proposed is a novel technique that simplifies the warping path to highlight, quantify, and visualize key transformations (shift, compression, difference in amplitude) between time series subsequences.

Result: The result is a clearer representation of how subsequences match between time series, enhancing interpretability in time series comparison tasks.

Conclusion: The conclusion states that the proposed method improves the understanding of structural relationships and transformations in time series, making it easier to see where and how one series shifts, speeds up, or slows down relative to another.
...
### [234] [Over-squashing in Spatiotemporal Graph Neural Networks](https://arxiv.org/abs/2506.15507)
...
### [235] [RePCS: Diagnosing Data Memorization in LLM-Powered Retrieval-Augmented Generation](https://arxiv.org/abs/2506.15513)
...
### [236] [Learning Algorithms in the Limit](https://arxiv.org/abs/2506.15543)
...
### [237] [DAILOC: Domain-Incremental Learning for Indoor Localization using Smartphones](https://arxiv.org/abs/2506.15554)
*Akhil Singampalli,Danish Gufran,Sudeep Pasricha*

Main category: cs.LG

TL;DR: DAILOC is a new method for indoor localization using Wi-Fi fingerprints that handles changes over time and differences between devices better than previous approaches.


<details>
  <summary>Details</summary>
Motivation: The motivation is to solve the problem of domain shifts in Wi-Fi fingerprinting localization, which happen because devices are different and environments change over time, making existing methods not work well.

Method: DAILOC uses a multi-level variational autoencoder to separate features that are important for location from those caused by domain shifts. It also has a memory-guided class latent alignment mechanism to prevent forgetting old information when learning new things.

Result: Experiments showed DAILOC works better than previous methods. It has 2.74 times lower average error and 4.6 times lower worst-case error.

Conclusion: The conclusion is that DAILOC is effective at handling both device and time-related domain shifts in Wi-Fi localization, leading to more accurate and reliable indoor positioning.
...
### [238] [Towards Explainable Indoor Localization: Interpreting Neural Network Learning on Wi-Fi Fingerprints Using Logic Gates](https://arxiv.org/abs/2506.15559)
...
### [239] [GFLC: Graph-based Fairness-aware Label Correction for Fair Classification](https://arxiv.org/abs/2506.15620)
...
### [240] [Federated Learning for MRI-based BrainAGE: a multicenter study on post-stroke functional outcome prediction](https://arxiv.org/abs/2506.15626)
...
### [241] [Efficient Serving of LLM Applications with Probabilistic Demand Modeling](https://arxiv.org/abs/2506.14851)
...
### [242] [Cost-Efficient Serving of LLM Agents via Test-Time Plan Caching](https://arxiv.org/abs/2506.14852)
*Qizheng Zhang,Michael Wornow,Kunle Olukotun*

Main category: cs.DC

TL;DR: The paper proposes agentic plan caching to reduce costs in LLM-based agents by reusing structured plan templates across similar tasks.


<details>
  <summary>Details</summary>
Motivation: LLM-based agentic applications are costly due to extensive planning and reasoning, and existing caching methods aren't suitable for their context-dependent outputs.

Method: Extracts, stores, adapts, and reuses structured plan templates from past agent executions using keyword extraction and lightweight models for adaptation.

Result: Achieves a 46.62% average cost reduction while maintaining performance in real-world agentic applications.

Conclusion: Agentic plan caching provides an efficient complementary solution to existing LLM serving infrastructures for reducing costs in agentic applications.
